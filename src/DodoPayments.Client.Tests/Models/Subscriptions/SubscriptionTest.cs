...
public class SubscriptionTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ScheduledChange expectedScheduledChange = new()
        {
            ID = "id",
            Addons =
            [
...
public class ScheduledChangeTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ScheduledChange
        {
            ID = "id",
            Addons =
            [
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ScheduledChange>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ScheduledChange copied = new(model);
