...
public class SubscriptionListResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        SubscriptionListResponseScheduledChange expectedScheduledChange = new()
        {
            ID = "id",
            Addons =
            [
...
public class SubscriptionListResponseScheduledChangeTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionListResponseScheduledChange
        {
            ID = "id",
            Addons =
            [
        ...
        List<SubscriptionListResponseScheduledChangeAddon> expectedAddons =
        [
            new()
            {
                AddonID = "addon_id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<SubscriptionListResponseScheduledChange>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionListResponseScheduledChange copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class SubscriptionListResponseScheduledChangeAddonTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionListResponseScheduledChangeAddon
        {
            AddonID = "addon_id",
            Name = "name",
            Quantity = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<SubscriptionListResponseScheduledChangeAddon>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionListResponseScheduledChangeAddon copied = new(model);
