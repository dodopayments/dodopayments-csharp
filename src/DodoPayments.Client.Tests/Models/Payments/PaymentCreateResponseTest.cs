...
public class PaymentCreateResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<PaymentCreateResponseProductCart> expectedProductCart =
        [
            new()
            {
                ProductID = "product_id",
...
public class PaymentCreateResponseProductCartTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PaymentCreateResponseProductCart
        {
            ProductID = "product_id",
            Quantity = 0,
            Amount = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<PaymentCreateResponseProductCart>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new PaymentCreateResponseProductCart { ProductID = "product_id", Quantity = 0 };
    ...
    public void CopyConstructor_Works()
    {
        ...
        PaymentCreateResponseProductCart copied = new(model);
