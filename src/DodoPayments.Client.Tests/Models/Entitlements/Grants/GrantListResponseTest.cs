...
public class GrantListResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, GrantListResponseStatus> expectedStatus = GrantListResponseStatus.Pending;
...
{
    [Theory]
    [InlineData(GrantListResponseStatus.Pending)]
    [InlineData(GrantListResponseStatus.Delivered)]
    [InlineData(GrantListResponseStatus.Failed)]
    [InlineData(GrantListResponseStatus.Revoked)]
