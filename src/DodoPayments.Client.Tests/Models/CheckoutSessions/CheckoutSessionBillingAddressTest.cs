...
public class CheckoutSessionBillingAddressTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CheckoutSessionBillingAddress
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CheckoutSessionBillingAddress>(
            json,
    ...
    {
        var model = new CheckoutSessionBillingAddress { Country = CountryCode.Af };
    ...
    public void CopyConstructor_Works()
    {
        ...
        CheckoutSessionBillingAddress copied = new(model);
