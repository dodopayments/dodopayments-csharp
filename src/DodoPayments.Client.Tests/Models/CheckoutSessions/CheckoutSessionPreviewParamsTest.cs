    ...
    public void FieldRoundtrip_Works()
    {
        var parameters = new CheckoutSessionPreviewParams
        {
            ...
            Customization = new()
            {
                ...
                ThemeConfig = new()
                {
                    ...
                    FontSize = CheckoutSessionPreviewParamsCustomizationThemeConfigFontSize.Xs,
                    FontWeight =
                        CheckoutSessionPreviewParamsCustomizationThemeConfigFontWeight.Normal,
                    Light = new()
                    {
                        BgPrimary = "bg_primary",
                        BgSecondary = "bg_secondary",
        ...
        CheckoutSessionPreviewParamsCustomization expectedCustomization = new()
        {
            ...
            ThemeConfig = new()
            {
                ...
                FontSize = CheckoutSessionPreviewParamsCustomizationThemeConfigFontSize.Xs,
                FontWeight = CheckoutSessionPreviewParamsCustomizationThemeConfigFontWeight.Normal,
                Light = new()
                {
                    BgPrimary = "bg_primary",
                    BgSecondary = "bg_secondary",
...
public class CheckoutSessionPreviewParamsCustomizationTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        CheckoutSessionPreviewParamsCustomizationThemeConfig expectedThemeConfig = new()
        {
            Dark = new()
            {
                BgPrimary = "bg_primary",
...
public class CheckoutSessionPreviewParamsCustomizationThemeConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CheckoutSessionPreviewParamsCustomizationThemeConfig
        {
            Dark = new()
            {
                BgPrimary = "bg_primary",
        ...
        CheckoutSessionPreviewParamsCustomizationThemeConfigDark expectedDark = new()
        {
            BgPrimary = "bg_primary",
            BgSecondary = "bg_secondary",
            BorderPrimary = "border_primary",
        ...
        > expectedFontSize = CheckoutSessionPreviewParamsCustomizationThemeConfigFontSize.Xs;
        ApiEnum<
            string,
            CheckoutSessionPreviewParamsCustomizationThemeConfigFontWeight
        > expectedFontWeight =
            CheckoutSessionPreviewParamsCustomizationThemeConfigFontWeight.Normal;
        CheckoutSessionPreviewParamsCustomizationThemeConfigLight expectedLight = new()
        {
            BgPrimary = "bg_primary",
            BgSecondary = "bg_secondary",
            BorderPrimary = "border_primary",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<CheckoutSessionPreviewParamsCustomizationThemeConfig>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CheckoutSessionPreviewParamsCustomizationThemeConfig copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class CheckoutSessionPreviewParamsCustomizationThemeConfigDarkTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CheckoutSessionPreviewParamsCustomizationThemeConfigDark
        {
            BgPrimary = "bg_primary",
            BgSecondary = "bg_secondary",
            BorderPrimary = "border_primary",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<CheckoutSessionPreviewParamsCustomizationThemeConfigDark>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CheckoutSessionPreviewParamsCustomizationThemeConfigDark copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class CheckoutSessionPreviewParamsCustomizationThemeConfigFontSizeTest : TestBase
{
    [Theory]
    [InlineData(CheckoutSessionPreviewParamsCustomizationThemeConfigFontSize.Xs)]
    [InlineData(CheckoutSessionPreviewParamsCustomizationThemeConfigFontSize.Sm)]
    [InlineData(CheckoutSessionPreviewParamsCustomizationThemeConfigFontSize.Md)]
    [InlineData(CheckoutSessionPreviewParamsCustomizationThemeConfigFontSize.Lg)]
    [InlineData(CheckoutSessionPreviewParamsCustomizationThemeConfigFontSize.Xl)]
    [InlineData(CheckoutSessionPreviewParamsCustomizationThemeConfigFontSize.V2xl)]
    public void Validation_Works(
        CheckoutSessionPreviewParamsCustomizationThemeConfigFontSize rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CheckoutSessionPreviewParamsCustomizationThemeConfigFontSize> value =
            rawValue;
        value.Validate();
    }
...
public class CheckoutSessionPreviewParamsCustomizationThemeConfigFontWeightTest : TestBase
{
    [Theory]
    [InlineData(CheckoutSessionPreviewParamsCustomizationThemeConfigFontWeight.Normal)]
    [InlineData(CheckoutSessionPreviewParamsCustomizationThemeConfigFontWeight.Medium)]
    [InlineData(CheckoutSessionPreviewParamsCustomizationThemeConfigFontWeight.Bold)]
    [InlineData(CheckoutSessionPreviewParamsCustomizationThemeConfigFontWeight.ExtraBold)]
    public void Validation_Works(
        CheckoutSessionPreviewParamsCustomizationThemeConfigFontWeight rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CheckoutSessionPreviewParamsCustomizationThemeConfigFontWeight> value =
            rawValue;
        value.Validate();
    }
...
public class CheckoutSessionPreviewParamsCustomizationThemeConfigLightTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CheckoutSessionPreviewParamsCustomizationThemeConfigLight
        {
            BgPrimary = "bg_primary",
            BgSecondary = "bg_secondary",
            BorderPrimary = "border_primary",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<CheckoutSessionPreviewParamsCustomizationThemeConfigLight>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CheckoutSessionPreviewParamsCustomizationThemeConfigLight copied = new(model);
