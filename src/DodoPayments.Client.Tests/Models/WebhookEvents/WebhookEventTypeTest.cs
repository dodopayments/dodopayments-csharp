...
public class WebhookEventTypeTest : TestBase
{
    ...
    [InlineData(WebhookEventType.SubscriptionPastDue)]
    [InlineData(WebhookEventType.SubscriptionPaused)]
    [InlineData(WebhookEventType.SubscriptionUnpaused)]
    ...
    [InlineData(WebhookEventType.SubscriptionUpdatePaymentMethod)]
    [InlineData(WebhookEventType.LicenseKeyCreated)]
    [InlineData(WebhookEventType.PayoutCreated)]
    ...
    [InlineData(WebhookEventType.CreditOverageReset)]
