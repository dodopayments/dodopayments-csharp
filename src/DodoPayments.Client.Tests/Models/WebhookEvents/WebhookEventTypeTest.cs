...
public class WebhookEventTypeTest : TestBase
{
    ...
    [InlineData(WebhookEventType.SubscriptionCancellationScheduled)]
    [InlineData(WebhookEventType.SubscriptionTrialEnding)]
    [InlineData(WebhookEventType.SubscriptionUpcomingRenewal)]
