...
public class CustomerListEntitlementGrantsParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new CustomerListEntitlementGrantsParams
        {
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://live.dodopayments.com/customers/cus_TV52uJWWXt2yIoBBxpjaa/entitlement-grants?integration_type=discord&page_number=0&page_size=0&status=Pending"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CustomerListEntitlementGrantsParams copied = new(parameters);
