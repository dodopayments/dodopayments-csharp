...
public class CustomerListEntitlementGrantsPageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CustomerListEntitlementGrantsPageResponse
        {
            Items =
            [
                new()
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CustomerListEntitlementGrantsPageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        CustomerListEntitlementGrantsPageResponse copied = new(model);
