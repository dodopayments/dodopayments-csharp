...
public class Data7IntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(Data7IntersectionMember1PayloadType.Payment)]
    public void Validation_Works(Data7IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data7IntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, Data7IntersectionMember1PayloadType>
        >(
    ...
    [Theory]
    [InlineData(Data7IntersectionMember1PayloadType.Payment)]
    public void SerializationRoundtrip_Works(Data7IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data7IntersectionMember1PayloadType> value = rawValue;
...
public class Type7Test : TestBase
{
    [Theory]
    [InlineData(Type7.PaymentCancelled)]
    public void Validation_Works(Type7 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type7> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Type7>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
        Assert.Throws<DodoPaymentsInvalidDataException>(() => value.Validate());
    ...
    [Theory]
    [InlineData(Type7.PaymentCancelled)]
    public void SerializationRoundtrip_Works(Type7 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type7> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Type7>>(
            json,
            ModelBase.SerializerOptions
        );
