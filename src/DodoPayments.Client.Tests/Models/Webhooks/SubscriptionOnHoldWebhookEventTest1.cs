...
public class SubscriptionOnHoldWebhookEventTest1 : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionOnHoldWebhookEvent
        {
            ...
            Data = new()
            {
                ...
                TaxID = "tax_id",
                PayloadType = Data17IntersectionMember1PayloadType.Subscription,
            },
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Type = Type17.SubscriptionOnHold,
        };

        string expectedBusinessID = "business_id";
        Data17 expectedData = new()
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
        ...
        ApiEnum<string, Type17> expectedType = Type17.SubscriptionOnHold;
...
public class Data17Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data17
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
        ...
        ApiEnum<string, Data17IntersectionMember1PayloadType> expectedPayloadType =
            Data17IntersectionMember1PayloadType.Subscription;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data17>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data17>(element);
        Assert.NotNull(deserialized);
...
public class Data17IntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data17IntersectionMember1
        {
            PayloadType = Data17IntersectionMember1PayloadType.Subscription,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data17IntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data17IntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
public class Data17IntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(Data17IntersectionMember1PayloadType.Subscription)]
    public void Validation_Works(Data17IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data17IntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(Data17IntersectionMember1PayloadType.Subscription)]
    public void SerializationRoundtrip_Works(Data17IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data17IntersectionMember1PayloadType> value = rawValue;
...
public class Type17Test : TestBase
{
    [Theory]
    [InlineData(Type17.SubscriptionOnHold)]
    public void Validation_Works(Type17 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type17> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Type17>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
        Assert.Throws<DodoPaymentsInvalidDataException>(() => value.Validate());
    ...
    [Theory]
    [InlineData(Type17.SubscriptionOnHold)]
    public void SerializationRoundtrip_Works(Type17 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type17> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Type17>>(
            json,
            ModelBase.SerializerOptions
        );
