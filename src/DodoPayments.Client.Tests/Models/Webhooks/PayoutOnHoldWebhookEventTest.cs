...
public class PayoutOnHoldWebhookEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PayoutOnHoldWebhookEvent
        {
            ...
            Data = new()
            {
                ...
                PayoutID = "payout_id",
                Refunds = 0,
                Status = PayoutOnHoldWebhookEventDataStatus.NotInitiated,
                Tax = 0,
        ...
        PayoutOnHoldWebhookEventData expectedData = new()
        {
            Amount = 0,
            BusinessID = "business_id",
            Chargebacks = 0,
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("payout.on_hold");
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<PayoutOnHoldWebhookEvent>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        PayoutOnHoldWebhookEvent copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class PayoutOnHoldWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PayoutOnHoldWebhookEventData
        {
            Amount = 0,
            BusinessID = "business_id",
            Chargebacks = 0,
        ...
        ApiEnum<string, PayoutOnHoldWebhookEventDataStatus> expectedStatus =
            PayoutOnHoldWebhookEventDataStatus.NotInitiated;
        long expectedTax = 0;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<PayoutOnHoldWebhookEventData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        PayoutOnHoldWebhookEventData copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class PayoutOnHoldWebhookEventDataStatusTest : TestBase
{
    [Theory]
    [InlineData(PayoutOnHoldWebhookEventDataStatus.NotInitiated)]
    [InlineData(PayoutOnHoldWebhookEventDataStatus.InProgress)]
    [InlineData(PayoutOnHoldWebhookEventDataStatus.OnHold)]
    [InlineData(PayoutOnHoldWebhookEventDataStatus.Failed)]
    [InlineData(PayoutOnHoldWebhookEventDataStatus.Success)]
    public void Validation_Works(PayoutOnHoldWebhookEventDataStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PayoutOnHoldWebhookEventDataStatus> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, PayoutOnHoldWebhookEventDataStatus>>(
    ...
    [InlineData(PayoutOnHoldWebhookEventDataStatus.Failed)]
    [InlineData(PayoutOnHoldWebhookEventDataStatus.Success)]
    public void SerializationRoundtrip_Works(PayoutOnHoldWebhookEventDataStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PayoutOnHoldWebhookEventDataStatus> value = rawValue;
