...
public class SubscriptionFailedWebhookEventTest1 : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionFailedWebhookEvent
        {
            ...
            Data = new()
            {
                ...
                TaxID = "tax_id",
                PayloadType = Data16IntersectionMember1PayloadType.Subscription,
            },
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Type = Type16.SubscriptionFailed,
        };

        string expectedBusinessID = "business_id";
        Data16 expectedData = new()
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
        ...
        ApiEnum<string, Type16> expectedType = Type16.SubscriptionFailed;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<SubscriptionFailedWebhookEvent>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<SubscriptionFailedWebhookEvent>(element);
...
public class Data16Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data16
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
        ...
        ApiEnum<string, Data16IntersectionMember1PayloadType> expectedPayloadType =
            Data16IntersectionMember1PayloadType.Subscription;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data16>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data16>(element);
        Assert.NotNull(deserialized);
...
public class Data16IntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data16IntersectionMember1
        {
            PayloadType = Data16IntersectionMember1PayloadType.Subscription,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data16IntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data16IntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
public class Data16IntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(Data16IntersectionMember1PayloadType.Subscription)]
    public void Validation_Works(Data16IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data16IntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(Data16IntersectionMember1PayloadType.Subscription)]
    public void SerializationRoundtrip_Works(Data16IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data16IntersectionMember1PayloadType> value = rawValue;
...
public class Type16Test : TestBase
{
    [Theory]
    [InlineData(Type16.SubscriptionFailed)]
    public void Validation_Works(Type16 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type16> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Type16>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
    ...
    [Theory]
    [InlineData(Type16.SubscriptionFailed)]
    public void SerializationRoundtrip_Works(Type16 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type16> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Type16>>(
            json,
            ModelBase.SerializerOptions
        );
