    ...
    public void FieldRoundtrip_Works()
    {
        var model = new RefundFailedWebhookEvent
        {
            ...
            Data = new()
            {
                ...
                Reason = "reason",
                PayloadType = Data11IntersectionMember1PayloadType.Refund,
            },
...
public class Data11Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data11
        {
            BusinessID = "business_id",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Customer = new()
        ...
        ApiEnum<string, Data11IntersectionMember1PayloadType> expectedPayloadType =
            Data11IntersectionMember1PayloadType.Refund;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data11>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data11>(element);
        Assert.NotNull(deserialized);
...
public class Data11IntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data11IntersectionMember1
        {
            PayloadType = Data11IntersectionMember1PayloadType.Refund,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data11IntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data11IntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
public class Data11IntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(Data11IntersectionMember1PayloadType.Refund)]
    public void Validation_Works(Data11IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data11IntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(Data11IntersectionMember1PayloadType.Refund)]
    public void SerializationRoundtrip_Works(Data11IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data11IntersectionMember1PayloadType> value = rawValue;
