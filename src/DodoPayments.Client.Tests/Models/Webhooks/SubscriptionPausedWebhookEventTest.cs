...
public class SubscriptionPausedWebhookEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionPausedWebhookEvent
        {
        ...
        SubscriptionPausedWebhookEventData expectedData = new()
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("subscription.paused");
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<SubscriptionPausedWebhookEvent>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionPausedWebhookEvent copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class SubscriptionPausedWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionPausedWebhookEventData
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<SubscriptionPausedWebhookEventData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionPausedWebhookEventData copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class SubscriptionPausedWebhookEventDataIntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionPausedWebhookEventDataIntersectionMember1
        {
            PastDueEndsAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<SubscriptionPausedWebhookEventDataIntersectionMember1>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionPausedWebhookEventDataIntersectionMember1 copied = new(model);
