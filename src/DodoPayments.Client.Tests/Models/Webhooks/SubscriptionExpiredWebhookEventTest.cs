...
public class SubscriptionExpiredWebhookEventTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("subscription.expired");
...
public class SubscriptionExpiredWebhookEventDataTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<SubscriptionExpiredWebhookEventData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionExpiredWebhookEventData copied = new(model);
...
public class SubscriptionExpiredWebhookEventDataIntersectionMember1Test : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionExpiredWebhookEventDataIntersectionMember1 copied = new(model);
