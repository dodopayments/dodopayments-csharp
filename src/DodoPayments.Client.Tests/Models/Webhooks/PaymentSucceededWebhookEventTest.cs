    ...
    public void FieldRoundtrip_Works()
    {
        var model = new PaymentSucceededWebhookEvent
        {
            ...
            Data = new()
            {
                ...
                PayloadType =
                    PaymentSucceededWebhookEventDataIntersectionMember1PayloadType.Payment,
            },
        ...
        PaymentSucceededWebhookEventData expectedData = new()
        {
            Billing = new()
            {
                Country = CountryCode.Af,
...
public class PaymentSucceededWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PaymentSucceededWebhookEventData
        {
            Billing = new()
            {
                Country = CountryCode.Af,
...
public class PaymentSucceededWebhookEventDataIntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PaymentSucceededWebhookEventDataIntersectionMember1
        {
            PayloadType = PaymentSucceededWebhookEventDataIntersectionMember1PayloadType.Payment,
        };
...
public class PaymentSucceededWebhookEventDataIntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(PaymentSucceededWebhookEventDataIntersectionMember1PayloadType.Payment)]
    public void Validation_Works(
        PaymentSucceededWebhookEventDataIntersectionMember1PayloadType rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PaymentSucceededWebhookEventDataIntersectionMember1PayloadType> value =
            rawValue;
        value.Validate();
    }
