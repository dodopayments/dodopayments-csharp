...
public class DisputeLostWebhookEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DisputeLostWebhookEvent
        {
            ...
            Data = new()
            {
                ...
                Remarks = "remarks",
                PayloadType = DisputeLostWebhookEventDataIntersectionMember1PayloadType.Dispute,
            },
        ...
        DisputeLostWebhookEventData expectedData = new()
        {
            Amount = "amount",
            BusinessID = "business_id",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
        ...
        ApiEnum<string, DisputeLostWebhookEventType> expectedType =
            DisputeLostWebhookEventType.DisputeLost;
...
public class DisputeLostWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DisputeLostWebhookEventData
        {
            Amount = "amount",
            BusinessID = "business_id",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
        ...
        > expectedPayloadType = DisputeLostWebhookEventDataIntersectionMember1PayloadType.Dispute;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<DisputeLostWebhookEventData>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<DisputeLostWebhookEventData>(element);
        Assert.NotNull(deserialized);
...
public class DisputeLostWebhookEventDataIntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DisputeLostWebhookEventDataIntersectionMember1
        {
            PayloadType = DisputeLostWebhookEventDataIntersectionMember1PayloadType.Dispute,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<DisputeLostWebhookEventDataIntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<DisputeLostWebhookEventDataIntersectionMember1>(element);
        Assert.NotNull(deserialized);
