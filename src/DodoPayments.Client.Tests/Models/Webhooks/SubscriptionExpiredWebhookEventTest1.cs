...
public class SubscriptionExpiredWebhookEventTest1 : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, Type15> expectedType = Type15.SubscriptionExpired;
...
public class Data15Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data15
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
        ...
        ApiEnum<string, Data15IntersectionMember1PayloadType> expectedPayloadType =
            Data15IntersectionMember1PayloadType.Subscription;
...
public class Data15IntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data15IntersectionMember1
        {
            PayloadType = Data15IntersectionMember1PayloadType.Subscription,
        };
...
public class Data15IntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(Data15IntersectionMember1PayloadType.Subscription)]
    public void Validation_Works(Data15IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data15IntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(Data15IntersectionMember1PayloadType.Subscription)]
    public void SerializationRoundtrip_Works(Data15IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data15IntersectionMember1PayloadType> value = rawValue;
...
public class Type15Test : TestBase
{
    [Theory]
    [InlineData(Type15.SubscriptionExpired)]
    public void Validation_Works(Type15 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type15> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Type15>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
    ...
    [Theory]
    [InlineData(Type15.SubscriptionExpired)]
    public void SerializationRoundtrip_Works(Type15 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type15> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Type15>>(
            json,
            ModelBase.SerializerOptions
        );
