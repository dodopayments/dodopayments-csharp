...
public class PaymentProcessingWebhookEventTest1 : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PaymentProcessingWebhookEvent
        {
            ...
            Type = Type9.PaymentProcessing,
        };

        string expectedBusinessID = "business_id";
        Data9 expectedData = new()
        {
            Billing = new()
            {
                Country = CountryCode.Af,
        ...
        ApiEnum<string, Type9> expectedType = Type9.PaymentProcessing;
...
public class Data9Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, Data9IntersectionMember1PayloadType> expectedPayloadType =
            Data9IntersectionMember1PayloadType.Payment;
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data9>(element);
        Assert.NotNull(deserialized);
...
public class Data9IntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data9IntersectionMember1
        {
            PayloadType = Data9IntersectionMember1PayloadType.Payment,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data9IntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data9IntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
public class Data9IntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(Data9IntersectionMember1PayloadType.Payment)]
    public void Validation_Works(Data9IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data9IntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, Data9IntersectionMember1PayloadType>
        >(
    ...
    [Theory]
    [InlineData(Data9IntersectionMember1PayloadType.Payment)]
    public void SerializationRoundtrip_Works(Data9IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data9IntersectionMember1PayloadType> value = rawValue;
...
public class Type9Test : TestBase
{
    [Theory]
    [InlineData(Type9.PaymentProcessing)]
    public void Validation_Works(Type9 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type9> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Type9>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
    ...
    [Theory]
    [InlineData(Type9.PaymentProcessing)]
    public void SerializationRoundtrip_Works(Type9 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type9> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Type9>>(
            json,
            ModelBase.SerializerOptions
        );
