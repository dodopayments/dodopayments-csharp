...
public class PayoutSuccessWebhookEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PayoutSuccessWebhookEvent
        {
            ...
            Data = new()
            {
                ...
                PayoutID = "payout_id",
                Refunds = 0,
                Status = PayoutSuccessWebhookEventDataStatus.NotInitiated,
                Tax = 0,
        ...
        PayoutSuccessWebhookEventData expectedData = new()
        {
            Amount = 0,
            BusinessID = "business_id",
            Chargebacks = 0,
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("payout.success");
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<PayoutSuccessWebhookEvent>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        PayoutSuccessWebhookEvent copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class PayoutSuccessWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PayoutSuccessWebhookEventData
        {
            Amount = 0,
            BusinessID = "business_id",
            Chargebacks = 0,
        ...
        ApiEnum<string, PayoutSuccessWebhookEventDataStatus> expectedStatus =
            PayoutSuccessWebhookEventDataStatus.NotInitiated;
        long expectedTax = 0;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<PayoutSuccessWebhookEventData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        PayoutSuccessWebhookEventData copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class PayoutSuccessWebhookEventDataStatusTest : TestBase
{
    [Theory]
    [InlineData(PayoutSuccessWebhookEventDataStatus.NotInitiated)]
    [InlineData(PayoutSuccessWebhookEventDataStatus.InProgress)]
    [InlineData(PayoutSuccessWebhookEventDataStatus.OnHold)]
    [InlineData(PayoutSuccessWebhookEventDataStatus.Failed)]
    [InlineData(PayoutSuccessWebhookEventDataStatus.Success)]
    public void Validation_Works(PayoutSuccessWebhookEventDataStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PayoutSuccessWebhookEventDataStatus> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(PayoutSuccessWebhookEventDataStatus.Failed)]
    [InlineData(PayoutSuccessWebhookEventDataStatus.Success)]
    public void SerializationRoundtrip_Works(PayoutSuccessWebhookEventDataStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PayoutSuccessWebhookEventDataStatus> value = rawValue;
