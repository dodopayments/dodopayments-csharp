...
public class SubscriptionRenewedWebhookEventDataTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<SubscriptionRenewedWebhookEventData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionRenewedWebhookEventData copied = new(model);
...
public class SubscriptionRenewedWebhookEventDataIntersectionMember1Test : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionRenewedWebhookEventDataIntersectionMember1 copied = new(model);
