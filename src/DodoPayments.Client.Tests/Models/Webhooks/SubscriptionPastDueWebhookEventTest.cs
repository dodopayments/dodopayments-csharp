...
public class SubscriptionPastDueWebhookEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionPastDueWebhookEvent
        {
        ...
        SubscriptionPastDueWebhookEventData expectedData = new()
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("subscription.past_due");
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<SubscriptionPastDueWebhookEvent>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionPastDueWebhookEvent copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class SubscriptionPastDueWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionPastDueWebhookEventData
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<SubscriptionPastDueWebhookEventData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionPastDueWebhookEventData copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class SubscriptionPastDueWebhookEventDataIntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionPastDueWebhookEventDataIntersectionMember1
        {
            PastDueEndsAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<SubscriptionPastDueWebhookEventDataIntersectionMember1>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionPastDueWebhookEventDataIntersectionMember1 copied = new(model);
