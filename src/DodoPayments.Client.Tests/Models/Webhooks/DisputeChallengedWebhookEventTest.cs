...
public class DisputeChallengedWebhookEventDataTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<DisputeChallengedWebhookEventData>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<DisputeChallengedWebhookEventData>(element);
        Assert.NotNull(deserialized);
...
public class DisputeChallengedWebhookEventDataIntersectionMember1Test : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<DisputeChallengedWebhookEventDataIntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<DisputeChallengedWebhookEventDataIntersectionMember1>(
                element
            );
        Assert.NotNull(deserialized);
...
public class DisputeChallengedWebhookEventDataIntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(DisputeChallengedWebhookEventDataIntersectionMember1PayloadType.Dispute)]
    public void Validation_Works(
        DisputeChallengedWebhookEventDataIntersectionMember1PayloadType rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DisputeChallengedWebhookEventDataIntersectionMember1PayloadType> value =
            rawValue;
        value.Validate();
    }
...
public class DisputeChallengedWebhookEventTypeTest : TestBase
{
    [Theory]
    [InlineData(DisputeChallengedWebhookEventType.DisputeChallenged)]
    public void Validation_Works(DisputeChallengedWebhookEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DisputeChallengedWebhookEventType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, DisputeChallengedWebhookEventType>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
    ...
    [Theory]
    [InlineData(DisputeChallengedWebhookEventType.DisputeChallenged)]
    public void SerializationRoundtrip_Works(DisputeChallengedWebhookEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DisputeChallengedWebhookEventType> value = rawValue;
