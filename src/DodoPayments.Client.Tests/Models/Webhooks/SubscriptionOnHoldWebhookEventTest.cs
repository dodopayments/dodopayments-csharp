...
public class SubscriptionOnHoldWebhookEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        SubscriptionOnHoldWebhookEventData expectedData = new()
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
...
public class SubscriptionOnHoldWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionOnHoldWebhookEventData
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<SubscriptionOnHoldWebhookEventData>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<SubscriptionOnHoldWebhookEventData>(element);
        Assert.NotNull(deserialized);
...
public class SubscriptionOnHoldWebhookEventDataIntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionOnHoldWebhookEventDataIntersectionMember1
        {
            PayloadType =
                SubscriptionOnHoldWebhookEventDataIntersectionMember1PayloadType.Subscription,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<SubscriptionOnHoldWebhookEventDataIntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<SubscriptionOnHoldWebhookEventDataIntersectionMember1>(
                element
            );
        Assert.NotNull(deserialized);
...
public class SubscriptionOnHoldWebhookEventDataIntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(SubscriptionOnHoldWebhookEventDataIntersectionMember1PayloadType.Subscription)]
    public void Validation_Works(
        SubscriptionOnHoldWebhookEventDataIntersectionMember1PayloadType rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, SubscriptionOnHoldWebhookEventDataIntersectionMember1PayloadType> value =
            rawValue;
        value.Validate();
    }
