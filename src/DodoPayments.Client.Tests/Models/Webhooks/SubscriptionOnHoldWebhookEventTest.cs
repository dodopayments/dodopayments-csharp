...
public class SubscriptionOnHoldWebhookEventDataTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<SubscriptionOnHoldWebhookEventData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionOnHoldWebhookEventData copied = new(model);
...
public class SubscriptionOnHoldWebhookEventDataIntersectionMember1Test : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionOnHoldWebhookEventDataIntersectionMember1 copied = new(model);
