...
public class PaymentCancelledWebhookEventDataTest : TestBase
{
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<PaymentCancelledWebhookEventData>(element);
        Assert.NotNull(deserialized);
...
public class PaymentCancelledWebhookEventDataIntersectionMember1Test : TestBase
{
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<PaymentCancelledWebhookEventDataIntersectionMember1>(
                element
            );
        Assert.NotNull(deserialized);
...
public class PaymentCancelledWebhookEventDataIntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(PaymentCancelledWebhookEventDataIntersectionMember1PayloadType.Payment)]
    public void Validation_Works(
        PaymentCancelledWebhookEventDataIntersectionMember1PayloadType rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PaymentCancelledWebhookEventDataIntersectionMember1PayloadType> value =
            rawValue;
        value.Validate();
    }
