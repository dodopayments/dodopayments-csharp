...
public class EntitlementGrantRevokedWebhookEventTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        EntitlementGrantRevokedWebhookEventData expectedData = new()
        {
            ID = "id",
            BusinessID = "business_id",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
...
public class EntitlementGrantRevokedWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EntitlementGrantRevokedWebhookEventData
        {
            ID = "id",
            BusinessID = "business_id",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
        ...
        ApiEnum<string, EntitlementGrantRevokedWebhookEventDataStatus> expectedStatus =
            EntitlementGrantRevokedWebhookEventDataStatus.Pending;
        ...
        EntitlementGrantRevokedWebhookEventDataLicenseKey expectedLicenseKey = new()
        {
            ActivationsUsed = 0,
            Key = "key",
            ActivationsLimit = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<EntitlementGrantRevokedWebhookEventData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        EntitlementGrantRevokedWebhookEventData copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class EntitlementGrantRevokedWebhookEventDataStatusTest : TestBase
{
    [Theory]
    [InlineData(EntitlementGrantRevokedWebhookEventDataStatus.Pending)]
    [InlineData(EntitlementGrantRevokedWebhookEventDataStatus.Delivered)]
    [InlineData(EntitlementGrantRevokedWebhookEventDataStatus.Failed)]
    [InlineData(EntitlementGrantRevokedWebhookEventDataStatus.Revoked)]
    public void Validation_Works(EntitlementGrantRevokedWebhookEventDataStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, EntitlementGrantRevokedWebhookEventDataStatus> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(EntitlementGrantRevokedWebhookEventDataStatus.Failed)]
    [InlineData(EntitlementGrantRevokedWebhookEventDataStatus.Revoked)]
    public void SerializationRoundtrip_Works(EntitlementGrantRevokedWebhookEventDataStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, EntitlementGrantRevokedWebhookEventDataStatus> value = rawValue;
...
public class EntitlementGrantRevokedWebhookEventDataLicenseKeyTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EntitlementGrantRevokedWebhookEventDataLicenseKey
        {
            ActivationsUsed = 0,
            Key = "key",
            ActivationsLimit = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<EntitlementGrantRevokedWebhookEventDataLicenseKey>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        EntitlementGrantRevokedWebhookEventDataLicenseKey copied = new(model);
