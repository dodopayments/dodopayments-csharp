...
public class SubscriptionFailedWebhookEventTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        SubscriptionFailedWebhookEventData expectedData = new()
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
...
public class SubscriptionFailedWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionFailedWebhookEventData
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<SubscriptionFailedWebhookEventData>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<SubscriptionFailedWebhookEventData>(element);
        Assert.NotNull(deserialized);
...
public class SubscriptionFailedWebhookEventDataIntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionFailedWebhookEventDataIntersectionMember1
        {
            PayloadType =
                SubscriptionFailedWebhookEventDataIntersectionMember1PayloadType.Subscription,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<SubscriptionFailedWebhookEventDataIntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<SubscriptionFailedWebhookEventDataIntersectionMember1>(
                element
            );
        Assert.NotNull(deserialized);
...
public class SubscriptionFailedWebhookEventDataIntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(SubscriptionFailedWebhookEventDataIntersectionMember1PayloadType.Subscription)]
    public void Validation_Works(
        SubscriptionFailedWebhookEventDataIntersectionMember1PayloadType rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, SubscriptionFailedWebhookEventDataIntersectionMember1PayloadType> value =
            rawValue;
        value.Validate();
    }
