...
public class SubscriptionFailedWebhookEventTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("subscription.failed");
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionFailedWebhookEvent copied = new(model);
...
public class SubscriptionFailedWebhookEventDataTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<SubscriptionFailedWebhookEventData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionFailedWebhookEventData copied = new(model);
...
public class SubscriptionFailedWebhookEventDataIntersectionMember1Test : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionFailedWebhookEventDataIntersectionMember1 copied = new(model);
