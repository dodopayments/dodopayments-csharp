...
public class PaymentFailedWebhookEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PaymentFailedWebhookEvent
        {
            ...
            Data = new()
            {
                ...
                PayloadType = PaymentFailedWebhookEventDataIntersectionMember1PayloadType.Payment,
            },
        ...
        PaymentFailedWebhookEventData expectedData = new()
        {
            Billing = new()
            {
                Country = CountryCode.Af,
        ...
        ApiEnum<string, PaymentFailedWebhookEventType> expectedType =
            PaymentFailedWebhookEventType.PaymentFailed;
...
public class PaymentFailedWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PaymentFailedWebhookEventData
        {
            Billing = new()
            {
                Country = CountryCode.Af,
        ...
        > expectedPayloadType = PaymentFailedWebhookEventDataIntersectionMember1PayloadType.Payment;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<PaymentFailedWebhookEventData>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<PaymentFailedWebhookEventData>(element);
        Assert.NotNull(deserialized);
...
public class PaymentFailedWebhookEventDataIntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PaymentFailedWebhookEventDataIntersectionMember1
        {
            PayloadType = PaymentFailedWebhookEventDataIntersectionMember1PayloadType.Payment,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<PaymentFailedWebhookEventDataIntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<PaymentFailedWebhookEventDataIntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
public class PaymentFailedWebhookEventDataIntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(PaymentFailedWebhookEventDataIntersectionMember1PayloadType.Payment)]
    public void Validation_Works(
        PaymentFailedWebhookEventDataIntersectionMember1PayloadType rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PaymentFailedWebhookEventDataIntersectionMember1PayloadType> value =
            rawValue;
        value.Validate();
    }
...
public class PaymentFailedWebhookEventTypeTest : TestBase
{
    [Theory]
    [InlineData(PaymentFailedWebhookEventType.PaymentFailed)]
    public void Validation_Works(PaymentFailedWebhookEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PaymentFailedWebhookEventType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, PaymentFailedWebhookEventType>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
    ...
    [Theory]
    [InlineData(PaymentFailedWebhookEventType.PaymentFailed)]
    public void SerializationRoundtrip_Works(PaymentFailedWebhookEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PaymentFailedWebhookEventType> value = rawValue;
        ...
        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, PaymentFailedWebhookEventType>
        >(json, ModelBase.SerializerOptions);
