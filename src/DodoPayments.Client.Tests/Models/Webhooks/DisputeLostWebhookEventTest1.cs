...
public class DisputeLostWebhookEventTest1 : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new DisputeLostWebhookEvent
        {
            ...
            Data = new()
            {
                ...
                Remarks = "remarks",
                PayloadType = Data3IntersectionMember1PayloadType.Dispute,
            },
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<DisputeLostWebhookEvent>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<DisputeLostWebhookEvent>(element);
...
public class Data3Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, Data3IntersectionMember1PayloadType> expectedPayloadType =
            Data3IntersectionMember1PayloadType.Dispute;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data3>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data3>(element);
        Assert.NotNull(deserialized);
...
public class Data3IntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data3IntersectionMember1
        {
            PayloadType = Data3IntersectionMember1PayloadType.Dispute,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data3IntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data3IntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
public class Data3IntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(Data3IntersectionMember1PayloadType.Dispute)]
    public void Validation_Works(Data3IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data3IntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, Data3IntersectionMember1PayloadType>
        >(
    ...
    [Theory]
    [InlineData(Data3IntersectionMember1PayloadType.Dispute)]
    public void SerializationRoundtrip_Works(Data3IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data3IntersectionMember1PayloadType> value = rawValue;
