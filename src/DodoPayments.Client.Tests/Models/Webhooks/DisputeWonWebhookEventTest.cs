...
public class DisputeWonWebhookEventDataTest : TestBase
{
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<DisputeWonWebhookEventData>(element);
        Assert.NotNull(deserialized);
...
public class DisputeWonWebhookEventDataIntersectionMember1Test : TestBase
{
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<DisputeWonWebhookEventDataIntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
public class DisputeWonWebhookEventDataIntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(DisputeWonWebhookEventDataIntersectionMember1PayloadType.Dispute)]
    public void Validation_Works(DisputeWonWebhookEventDataIntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DisputeWonWebhookEventDataIntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(DisputeWonWebhookEventDataIntersectionMember1PayloadType.Dispute)]
    public void SerializationRoundtrip_Works(
        DisputeWonWebhookEventDataIntersectionMember1PayloadType rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DisputeWonWebhookEventDataIntersectionMember1PayloadType> value = rawValue;
...
public class DisputeWonWebhookEventTypeTest : TestBase
{
    [Theory]
    [InlineData(DisputeWonWebhookEventType.DisputeWon)]
    public void Validation_Works(DisputeWonWebhookEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DisputeWonWebhookEventType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, DisputeWonWebhookEventType>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
    ...
    [Theory]
    [InlineData(DisputeWonWebhookEventType.DisputeWon)]
    public void SerializationRoundtrip_Works(DisputeWonWebhookEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DisputeWonWebhookEventType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, DisputeWonWebhookEventType>>(
            json,
            ModelBase.SerializerOptions
        );
