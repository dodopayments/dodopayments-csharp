...
public class Data13Test : TestBase
{
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data13>(element);
        Assert.NotNull(deserialized);
...
public class Data13IntersectionMember1Test : TestBase
{
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data13IntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
public class Data13IntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(Data13IntersectionMember1PayloadType.Subscription)]
    public void Validation_Works(Data13IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data13IntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(Data13IntersectionMember1PayloadType.Subscription)]
    public void SerializationRoundtrip_Works(Data13IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data13IntersectionMember1PayloadType> value = rawValue;
...
public class Type13Test : TestBase
{
    [Theory]
    [InlineData(Type13.SubscriptionActive)]
    public void Validation_Works(Type13 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type13> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Type13>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
    ...
    [Theory]
    [InlineData(Type13.SubscriptionActive)]
    public void SerializationRoundtrip_Works(Type13 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type13> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Type13>>(
            json,
            ModelBase.SerializerOptions
        );
