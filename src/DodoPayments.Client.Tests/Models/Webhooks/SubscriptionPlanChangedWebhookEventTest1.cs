...
public class SubscriptionPlanChangedWebhookEventTest1 : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionPlanChangedWebhookEvent
        {
            ...
            Data = new()
            {
                ...
                TaxID = "tax_id",
                PayloadType = Data18IntersectionMember1PayloadType.Subscription,
            },
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Type = Type18.SubscriptionPlanChanged,
        };

        string expectedBusinessID = "business_id";
        Data18 expectedData = new()
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
        ...
        ApiEnum<string, Type18> expectedType = Type18.SubscriptionPlanChanged;
...
public class Data18Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data18
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
        ...
        ApiEnum<string, Data18IntersectionMember1PayloadType> expectedPayloadType =
            Data18IntersectionMember1PayloadType.Subscription;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data18>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data18>(element);
        Assert.NotNull(deserialized);
...
public class Data18IntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data18IntersectionMember1
        {
            PayloadType = Data18IntersectionMember1PayloadType.Subscription,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data18IntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data18IntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
public class Data18IntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(Data18IntersectionMember1PayloadType.Subscription)]
    public void Validation_Works(Data18IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data18IntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(Data18IntersectionMember1PayloadType.Subscription)]
    public void SerializationRoundtrip_Works(Data18IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data18IntersectionMember1PayloadType> value = rawValue;
...
public class Type18Test : TestBase
{
    [Theory]
    [InlineData(Type18.SubscriptionPlanChanged)]
    public void Validation_Works(Type18 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type18> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Type18>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
    ...
    [Theory]
    [InlineData(Type18.SubscriptionPlanChanged)]
    public void SerializationRoundtrip_Works(Type18 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type18> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Type18>>(
            json,
            ModelBase.SerializerOptions
        );
