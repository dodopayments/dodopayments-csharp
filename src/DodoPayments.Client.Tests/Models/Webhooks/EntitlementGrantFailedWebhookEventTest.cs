...
public class EntitlementGrantFailedWebhookEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EntitlementGrantFailedWebhookEvent
        {
        ...
        EntitlementGrantFailedWebhookEventData expectedData = new()
        {
            ID = "id",
            BusinessID = "business_id",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
        ...
        ApiEnum<string, EntitlementGrantFailedWebhookEventType> expectedType =
    ...
    public void CopyConstructor_Works()
    {
        ...
        EntitlementGrantFailedWebhookEvent copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class EntitlementGrantFailedWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EntitlementGrantFailedWebhookEventData
        {
            ID = "id",
            BusinessID = "business_id",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
        ...
        ApiEnum<string, EntitlementGrantFailedWebhookEventDataStatus> expectedStatus =
            EntitlementGrantFailedWebhookEventDataStatus.Pending;
        ...
        EntitlementGrantFailedWebhookEventDataLicenseKey expectedLicenseKey = new()
        {
            ActivationsUsed = 0,
            Key = "key",
            ActivationsLimit = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<EntitlementGrantFailedWebhookEventData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        EntitlementGrantFailedWebhookEventData copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class EntitlementGrantFailedWebhookEventDataStatusTest : TestBase
{
    [Theory]
    [InlineData(EntitlementGrantFailedWebhookEventDataStatus.Pending)]
    [InlineData(EntitlementGrantFailedWebhookEventDataStatus.Delivered)]
    [InlineData(EntitlementGrantFailedWebhookEventDataStatus.Failed)]
    [InlineData(EntitlementGrantFailedWebhookEventDataStatus.Revoked)]
    public void Validation_Works(EntitlementGrantFailedWebhookEventDataStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, EntitlementGrantFailedWebhookEventDataStatus> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(EntitlementGrantFailedWebhookEventDataStatus.Failed)]
    [InlineData(EntitlementGrantFailedWebhookEventDataStatus.Revoked)]
    public void SerializationRoundtrip_Works(EntitlementGrantFailedWebhookEventDataStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, EntitlementGrantFailedWebhookEventDataStatus> value = rawValue;
...
public class EntitlementGrantFailedWebhookEventDataLicenseKeyTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EntitlementGrantFailedWebhookEventDataLicenseKey
        {
            ActivationsUsed = 0,
            Key = "key",
            ActivationsLimit = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<EntitlementGrantFailedWebhookEventDataLicenseKey>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        EntitlementGrantFailedWebhookEventDataLicenseKey copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class EntitlementGrantFailedWebhookEventTypeTest : TestBase
{
    [Theory]
    [InlineData(EntitlementGrantFailedWebhookEventType.EntitlementGrantFailed)]
    public void Validation_Works(EntitlementGrantFailedWebhookEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, EntitlementGrantFailedWebhookEventType> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(EntitlementGrantFailedWebhookEventType.EntitlementGrantFailed)]
    public void SerializationRoundtrip_Works(EntitlementGrantFailedWebhookEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, EntitlementGrantFailedWebhookEventType> value = rawValue;
