...
public class SubscriptionUpdatePaymentMethodWebhookEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionUpdatePaymentMethodWebhookEvent
        {
        ...
        SubscriptionUpdatePaymentMethodWebhookEventData expectedData = new()
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<SubscriptionUpdatePaymentMethodWebhookEvent>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionUpdatePaymentMethodWebhookEvent copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class SubscriptionUpdatePaymentMethodWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionUpdatePaymentMethodWebhookEventData
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<SubscriptionUpdatePaymentMethodWebhookEventData>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionUpdatePaymentMethodWebhookEventData copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1
        {
            PastDueEndsAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1 copied = new(model);
