...
public class PaymentSucceededWebhookEventTest1 : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PaymentSucceededWebhookEvent
        {
            ...
            Data = new()
            {
                ...
                PayloadType = Data10IntersectionMember1PayloadType.Payment,
            },
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Type = Type10.PaymentSucceeded,
        };

        string expectedBusinessID = "business_id";
        Data10 expectedData = new()
        {
            Billing = new()
            {
                Country = CountryCode.Af,
        ...
        ApiEnum<string, Type10> expectedType = Type10.PaymentSucceeded;
...
public class Data10Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data10
        {
            Billing = new()
            {
                Country = CountryCode.Af,
        ...
        ApiEnum<string, Data10IntersectionMember1PayloadType> expectedPayloadType =
            Data10IntersectionMember1PayloadType.Payment;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data10>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data10>(element);
        Assert.NotNull(deserialized);
...
public class Data10IntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data10IntersectionMember1
        {
            PayloadType = Data10IntersectionMember1PayloadType.Payment,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data10IntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data10IntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
public class Data10IntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(Data10IntersectionMember1PayloadType.Payment)]
    public void Validation_Works(Data10IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data10IntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(Data10IntersectionMember1PayloadType.Payment)]
    public void SerializationRoundtrip_Works(Data10IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data10IntersectionMember1PayloadType> value = rawValue;
...
public class Type10Test : TestBase
{
    [Theory]
    [InlineData(Type10.PaymentSucceeded)]
    public void Validation_Works(Type10 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type10> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Type10>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
    ...
    [Theory]
    [InlineData(Type10.PaymentSucceeded)]
    public void SerializationRoundtrip_Works(Type10 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type10> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Type10>>(
            json,
            ModelBase.SerializerOptions
        );
