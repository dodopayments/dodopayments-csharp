...
public class PaymentProcessingWebhookEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PaymentProcessingWebhookEvent
        {
        ...
        PaymentProcessingWebhookEventData expectedData = new()
        {
            Billing = new()
            {
                Country = CountryCode.Af,
        ...
        ApiEnum<string, PaymentProcessingWebhookEventType> expectedType =
            PaymentProcessingWebhookEventType.PaymentProcessing;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<PaymentProcessingWebhookEvent>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<PaymentProcessingWebhookEvent>(element);
...
public class PaymentProcessingWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PaymentProcessingWebhookEventData
        {
            Billing = new()
            {
                Country = CountryCode.Af,
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<PaymentProcessingWebhookEventData>(element);
        Assert.NotNull(deserialized);
...
public class PaymentProcessingWebhookEventDataIntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PaymentProcessingWebhookEventDataIntersectionMember1
        {
            PayloadType = PaymentProcessingWebhookEventDataIntersectionMember1PayloadType.Payment,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<PaymentProcessingWebhookEventDataIntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<PaymentProcessingWebhookEventDataIntersectionMember1>(
                element
            );
        Assert.NotNull(deserialized);
...
public class PaymentProcessingWebhookEventDataIntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(PaymentProcessingWebhookEventDataIntersectionMember1PayloadType.Payment)]
    public void Validation_Works(
        PaymentProcessingWebhookEventDataIntersectionMember1PayloadType rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PaymentProcessingWebhookEventDataIntersectionMember1PayloadType> value =
            rawValue;
        value.Validate();
    }
...
public class PaymentProcessingWebhookEventTypeTest : TestBase
{
    [Theory]
    [InlineData(PaymentProcessingWebhookEventType.PaymentProcessing)]
    public void Validation_Works(PaymentProcessingWebhookEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PaymentProcessingWebhookEventType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, PaymentProcessingWebhookEventType>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
        Assert.Throws<DodoPaymentsInvalidDataException>(() => value.Validate());
    ...
    [Theory]
    [InlineData(PaymentProcessingWebhookEventType.PaymentProcessing)]
    public void SerializationRoundtrip_Works(PaymentProcessingWebhookEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PaymentProcessingWebhookEventType> value = rawValue;
