...
public class PaymentFailedWebhookEventTest1 : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PaymentFailedWebhookEvent
        {
            ...
            Data = new()
            {
                ...
                PayloadType = Data8IntersectionMember1PayloadType.Payment,
            },
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Type = Type8.PaymentFailed,
        };

        string expectedBusinessID = "business_id";
        Data8 expectedData = new()
        {
            Billing = new()
            {
                Country = CountryCode.Af,
        ...
        ApiEnum<string, Type8> expectedType = Type8.PaymentFailed;
...
public class Data8Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, Data8IntersectionMember1PayloadType> expectedPayloadType =
            Data8IntersectionMember1PayloadType.Payment;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data8>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data8>(element);
        Assert.NotNull(deserialized);
...
public class Data8IntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data8IntersectionMember1
        {
            PayloadType = Data8IntersectionMember1PayloadType.Payment,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data8IntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data8IntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
public class Data8IntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(Data8IntersectionMember1PayloadType.Payment)]
    public void Validation_Works(Data8IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data8IntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, Data8IntersectionMember1PayloadType>
        >(
    ...
    [Theory]
    [InlineData(Data8IntersectionMember1PayloadType.Payment)]
    public void SerializationRoundtrip_Works(Data8IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data8IntersectionMember1PayloadType> value = rawValue;
...
public class Type8Test : TestBase
{
    [Theory]
    [InlineData(Type8.PaymentFailed)]
    public void Validation_Works(Type8 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type8> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Type8>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
        Assert.Throws<DodoPaymentsInvalidDataException>(() => value.Validate());
    ...
    [Theory]
    [InlineData(Type8.PaymentFailed)]
    public void SerializationRoundtrip_Works(Type8 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type8> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Type8>>(
            json,
            ModelBase.SerializerOptions
        );
