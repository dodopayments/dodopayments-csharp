...
public class SubscriptionRenewedWebhookEventTest1 : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionRenewedWebhookEvent
        {
            ...
            Data = new()
            {
                ...
                TaxID = "tax_id",
                PayloadType = Data19IntersectionMember1PayloadType.Subscription,
            },
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Type = Type19.SubscriptionRenewed,
        };

        string expectedBusinessID = "business_id";
        Data19 expectedData = new()
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
        ...
        ApiEnum<string, Type19> expectedType = Type19.SubscriptionRenewed;
...
public class Data19Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data19
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
        ...
        ApiEnum<string, Data19IntersectionMember1PayloadType> expectedPayloadType =
            Data19IntersectionMember1PayloadType.Subscription;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data19>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data19>(element);
        Assert.NotNull(deserialized);
...
public class Data19IntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data19IntersectionMember1
        {
            PayloadType = Data19IntersectionMember1PayloadType.Subscription,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data19IntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data19IntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
public class Data19IntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(Data19IntersectionMember1PayloadType.Subscription)]
    public void Validation_Works(Data19IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data19IntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(Data19IntersectionMember1PayloadType.Subscription)]
    public void SerializationRoundtrip_Works(Data19IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data19IntersectionMember1PayloadType> value = rawValue;
...
public class Type19Test : TestBase
{
    [Theory]
    [InlineData(Type19.SubscriptionRenewed)]
    public void Validation_Works(Type19 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type19> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Type19>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
    ...
    [Theory]
    [InlineData(Type19.SubscriptionRenewed)]
    public void SerializationRoundtrip_Works(Type19 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type19> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Type19>>(
            json,
            ModelBase.SerializerOptions
        );
