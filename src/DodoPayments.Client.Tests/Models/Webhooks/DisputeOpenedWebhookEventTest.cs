...
public class DisputeOpenedWebhookEventDataTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<DisputeOpenedWebhookEventData>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<DisputeOpenedWebhookEventData>(element);
        Assert.NotNull(deserialized);
...
public class DisputeOpenedWebhookEventDataIntersectionMember1Test : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<DisputeOpenedWebhookEventDataIntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<DisputeOpenedWebhookEventDataIntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
public class DisputeOpenedWebhookEventDataIntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(DisputeOpenedWebhookEventDataIntersectionMember1PayloadType.Dispute)]
    public void Validation_Works(
        DisputeOpenedWebhookEventDataIntersectionMember1PayloadType rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DisputeOpenedWebhookEventDataIntersectionMember1PayloadType> value =
            rawValue;
        value.Validate();
    }
