...
public class EntitlementGrantCreatedWebhookEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EntitlementGrantCreatedWebhookEvent
        {
        ...
        EntitlementGrantCreatedWebhookEventData expectedData = new()
        {
            ID = "id",
            BusinessID = "business_id",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
...
public class EntitlementGrantCreatedWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EntitlementGrantCreatedWebhookEventData
        {
            ID = "id",
            BusinessID = "business_id",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
        ...
        ApiEnum<string, EntitlementGrantCreatedWebhookEventDataStatus> expectedStatus =
            EntitlementGrantCreatedWebhookEventDataStatus.Pending;
        ...
        LicenseKey expectedLicenseKey = new()
        {
            ActivationsUsed = 0,
            Key = "key",
            ActivationsLimit = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<EntitlementGrantCreatedWebhookEventData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        EntitlementGrantCreatedWebhookEventData copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class EntitlementGrantCreatedWebhookEventDataStatusTest : TestBase
{
    [Theory]
    [InlineData(EntitlementGrantCreatedWebhookEventDataStatus.Pending)]
    [InlineData(EntitlementGrantCreatedWebhookEventDataStatus.Delivered)]
    [InlineData(EntitlementGrantCreatedWebhookEventDataStatus.Failed)]
    [InlineData(EntitlementGrantCreatedWebhookEventDataStatus.Revoked)]
    public void Validation_Works(EntitlementGrantCreatedWebhookEventDataStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, EntitlementGrantCreatedWebhookEventDataStatus> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(EntitlementGrantCreatedWebhookEventDataStatus.Failed)]
    [InlineData(EntitlementGrantCreatedWebhookEventDataStatus.Revoked)]
    public void SerializationRoundtrip_Works(EntitlementGrantCreatedWebhookEventDataStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, EntitlementGrantCreatedWebhookEventDataStatus> value = rawValue;
...
public class LicenseKeyTest : TestBase
{
    ...
    public void OptionalNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new LicenseKey { ActivationsUsed = 0, Key = "key" };
