...
public class EntitlementGrantDeliveredWebhookEventTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        EntitlementGrantDeliveredWebhookEventData expectedData = new()
        {
            ID = "id",
            BusinessID = "business_id",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
...
public class EntitlementGrantDeliveredWebhookEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EntitlementGrantDeliveredWebhookEventData
        {
            ID = "id",
            BusinessID = "business_id",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
        ...
        ApiEnum<string, EntitlementGrantDeliveredWebhookEventDataStatus> expectedStatus =
            EntitlementGrantDeliveredWebhookEventDataStatus.Pending;
        ...
        EntitlementGrantDeliveredWebhookEventDataLicenseKey expectedLicenseKey = new()
        {
            ActivationsUsed = 0,
            Key = "key",
            ActivationsLimit = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<EntitlementGrantDeliveredWebhookEventData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        EntitlementGrantDeliveredWebhookEventData copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class EntitlementGrantDeliveredWebhookEventDataStatusTest : TestBase
{
    [Theory]
    [InlineData(EntitlementGrantDeliveredWebhookEventDataStatus.Pending)]
    [InlineData(EntitlementGrantDeliveredWebhookEventDataStatus.Delivered)]
    [InlineData(EntitlementGrantDeliveredWebhookEventDataStatus.Failed)]
    [InlineData(EntitlementGrantDeliveredWebhookEventDataStatus.Revoked)]
    public void Validation_Works(EntitlementGrantDeliveredWebhookEventDataStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, EntitlementGrantDeliveredWebhookEventDataStatus> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(EntitlementGrantDeliveredWebhookEventDataStatus.Revoked)]
    public void SerializationRoundtrip_Works(
        EntitlementGrantDeliveredWebhookEventDataStatus rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, EntitlementGrantDeliveredWebhookEventDataStatus> value = rawValue;
...
public class EntitlementGrantDeliveredWebhookEventDataLicenseKeyTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EntitlementGrantDeliveredWebhookEventDataLicenseKey
        {
            ActivationsUsed = 0,
            Key = "key",
            ActivationsLimit = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<EntitlementGrantDeliveredWebhookEventDataLicenseKey>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        EntitlementGrantDeliveredWebhookEventDataLicenseKey copied = new(model);
