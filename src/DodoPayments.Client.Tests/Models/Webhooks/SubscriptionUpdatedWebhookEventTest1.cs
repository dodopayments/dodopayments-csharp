...
public class Data20IntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(Data20IntersectionMember1PayloadType.Subscription)]
    public void Validation_Works(Data20IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data20IntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(Data20IntersectionMember1PayloadType.Subscription)]
    public void SerializationRoundtrip_Works(Data20IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data20IntersectionMember1PayloadType> value = rawValue;
...
public class Type20Test : TestBase
{
    [Theory]
    [InlineData(Type20.SubscriptionUpdated)]
    public void Validation_Works(Type20 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type20> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Type20>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
        Assert.Throws<DodoPaymentsInvalidDataException>(() => value.Validate());
    ...
    [Theory]
    [InlineData(Type20.SubscriptionUpdated)]
    public void SerializationRoundtrip_Works(Type20 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type20> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Type20>>(
            json,
            ModelBase.SerializerOptions
        );
