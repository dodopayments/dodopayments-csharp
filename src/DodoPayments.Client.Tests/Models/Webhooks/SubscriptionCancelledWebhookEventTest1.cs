...
public class SubscriptionCancelledWebhookEventTest1 : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionCancelledWebhookEvent
        {
            ...
            Data = new()
            {
                ...
                TaxID = "tax_id",
                PayloadType = Data14IntersectionMember1PayloadType.Subscription,
            },
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Type = Type14.SubscriptionCancelled,
        };

        string expectedBusinessID = "business_id";
        Data14 expectedData = new()
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
        ...
        ApiEnum<string, Type14> expectedType = Type14.SubscriptionCancelled;
...
public class Data14Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data14
        {
            Addons = [new() { AddonID = "addon_id", Quantity = 0 }],
            Billing = new()
            {
        ...
        ApiEnum<string, Data14IntersectionMember1PayloadType> expectedPayloadType =
            Data14IntersectionMember1PayloadType.Subscription;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data14>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data14>(element);
        Assert.NotNull(deserialized);
...
public class Data14IntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Data14IntersectionMember1
        {
            PayloadType = Data14IntersectionMember1PayloadType.Subscription,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data14IntersectionMember1>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Data14IntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
public class Data14IntersectionMember1PayloadTypeTest : TestBase
{
    [Theory]
    [InlineData(Data14IntersectionMember1PayloadType.Subscription)]
    public void Validation_Works(Data14IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data14IntersectionMember1PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, Data14IntersectionMember1PayloadType>
        >(
    ...
    [Theory]
    [InlineData(Data14IntersectionMember1PayloadType.Subscription)]
    public void SerializationRoundtrip_Works(Data14IntersectionMember1PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Data14IntersectionMember1PayloadType> value = rawValue;
...
public class Type14Test : TestBase
{
    [Theory]
    [InlineData(Type14.SubscriptionCancelled)]
    public void Validation_Works(Type14 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type14> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Type14>>(
            JsonSerializer.Deserialize<JsonElement>("\"invalid value\""),
            ModelBase.SerializerOptions
        );
        Assert.Throws<DodoPaymentsInvalidDataException>(() => value.Validate());
    ...
    [Theory]
    [InlineData(Type14.SubscriptionCancelled)]
    public void SerializationRoundtrip_Works(Type14 rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Type14> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Type14>>(
            json,
            ModelBase.SerializerOptions
        );
