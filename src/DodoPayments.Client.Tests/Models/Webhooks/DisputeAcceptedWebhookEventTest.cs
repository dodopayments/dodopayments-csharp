...
public class DataTest : TestBase
{
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Webhooks::Data>(element);
        Assert.NotNull(deserialized);
...
public class IntersectionMember1Test : TestBase
{
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<Webhooks::IntersectionMember1>(element);
        Assert.NotNull(deserialized);
...
{
    [Theory]
    [InlineData(Webhooks::PayloadType.Dispute)]
    public void Validation_Works(Webhooks::PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Webhooks::PayloadType> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Webhooks::PayloadType>>(
    ...
    [Theory]
    [InlineData(Webhooks::PayloadType.Dispute)]
    public void SerializationRoundtrip_Works(Webhooks::PayloadType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Webhooks::PayloadType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Webhooks::PayloadType>>(
            json,
            ModelBase.SerializerOptions
        );
