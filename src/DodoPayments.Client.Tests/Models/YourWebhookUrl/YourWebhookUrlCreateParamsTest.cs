...
namespace DodoPayments.Client.Tests.Models.YourWebhookUrl;

public class YourWebhookUrlCreateParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new YourWebhookUrlCreateParams
        {
        ...
        ApiEnum<string, WebhookEvents::WebhookEventType> expectedType =
            WebhookEvents::WebhookEventType.PaymentSucceeded;
        string expectedWebhookID = "webhook-id";
        string expectedWebhookSignature = "webhook-signature";
        string expectedWebhookTimestamp = "webhook-timestamp";

        Assert.Equal(expectedBusinessID, parameters.BusinessID);
        ...
        Assert.Equal(expectedWebhookSignature, parameters.WebhookSignature);
        Assert.Equal(expectedWebhookTimestamp, parameters.WebhookTimestamp);
    }

    [Fact]
    public void Url_Works()
    {
        YourWebhookUrlCreateParams parameters = new()
        {
            BusinessID = "business_id",
            Data = new Payment()
            {
        ...
        Assert.Equal(new Uri("https://live.dodopayments.com/your-webhook-url"), url);
    }
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        parameters.AddHeadersToRequest(requestMessage, new() { BearerToken = "My Bearer Token" });

        Assert.Equal(["webhook-id"], requestMessage.Headers.GetValues("webhook-id"));
        Assert.Equal(["webhook-signature"], requestMessage.Headers.GetValues("webhook-signature"));
        Assert.Equal(["webhook-timestamp"], requestMessage.Headers.GetValues("webhook-timestamp"));
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        YourWebhookUrlCreateParams copied = new(parameters);
