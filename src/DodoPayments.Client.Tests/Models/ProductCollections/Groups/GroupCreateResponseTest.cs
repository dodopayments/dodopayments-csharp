...
public class GroupCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new GroupCreateResponse
        {
            GroupID = "group_id",
            Products =
            [
        ...
        List<GroupCreateResponseProduct> expectedProducts =
        [
            new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<GroupCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        GroupCreateResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class GroupCreateResponseProductTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new GroupCreateResponseProduct
        {
            ID = "id",
            AddonsCount = 0,
            FilesCount = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<GroupCreateResponseProduct>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        GroupCreateResponseProduct copied = new(model);
