...
public class ProductCollectionProductTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProductCollectionProduct
        {
            ID = "id",
            AddonsCount = 0,
            FilesCount = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ProductCollectionProduct>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProductCollectionProduct copied = new(model);
