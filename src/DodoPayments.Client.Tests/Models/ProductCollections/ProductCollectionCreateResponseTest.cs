...
public class ProductCollectionCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProductCollectionCreateResponse
        {
            ID = "id",
            BrandID = "brand_id",
        ...
        List<ProductCollectionCreateResponseGroup> expectedGroups =
        [
            new()
            {
                GroupID = "group_id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ProductCollectionCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProductCollectionCreateResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ProductCollectionCreateResponseGroupTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProductCollectionCreateResponseGroup
        {
            GroupID = "group_id",
            Products =
            [
        ...
        List<ProductCollectionCreateResponseGroupProduct> expectedProducts =
        [
            new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ProductCollectionCreateResponseGroup>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProductCollectionCreateResponseGroup copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ProductCollectionCreateResponseGroupProductTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProductCollectionCreateResponseGroupProduct
        {
            ID = "id",
            AddonsCount = 0,
            FilesCount = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ProductCollectionCreateResponseGroupProduct>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProductCollectionCreateResponseGroupProduct copied = new(model);
