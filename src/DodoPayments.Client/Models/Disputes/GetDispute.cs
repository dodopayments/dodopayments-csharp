...
public sealed record class GetDispute : ModelBase, IFromRaw<GetDispute>
{
    ...
    public GetDispute(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    GetDispute(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
#pragma warning restore CS8618

    public static GetDispute FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> properties)
    {
