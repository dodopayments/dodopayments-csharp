...
public sealed record class LicenseKey : JsonModel
{
    ...
    /// </summary>
    public required ApiEnum<string, LicenseKeySource> Source
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, LicenseKeySource>>("source");
        }
...
/// flows, 'import' for merchant-imported keys.
/// </summary>
[JsonConverter(typeof(LicenseKeySourceConverter))]
...
{
    public override LicenseKeySource Read(
