...
/// </summary>
public record class DiscountDeleteParams : ParamsBase
{
...
#pragma warning disable CS8618
    ...
    {
        this.DiscountID = discountDeleteParams.DiscountID;
    }
...
#pragma warning restore CS8618
    ...
    public static DiscountDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(DiscountDeleteParams? other)
    {
        if (other == null)
        {
            return false;
