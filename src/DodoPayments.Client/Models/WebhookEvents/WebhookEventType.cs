...
sealed class WebhookEventTypeConverter : JsonConverter<WebhookEventType>
{
    ...
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            ...
            "subscription.past_due" => WebhookEventType.SubscriptionPastDue,
            "subscription.paused" => WebhookEventType.SubscriptionPaused,
            "subscription.unpaused" => WebhookEventType.SubscriptionUnpaused,
    ...
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                ...
                WebhookEventType.SubscriptionPastDue => "subscription.past_due",
                WebhookEventType.SubscriptionPaused => "subscription.paused",
                WebhookEventType.SubscriptionUnpaused => "subscription.unpaused",
