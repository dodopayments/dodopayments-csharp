    ...
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            ...
            "subscription.cancellation_scheduled" =>
                WebhookEventType.SubscriptionCancellationScheduled,
            "subscription.trial_ending" => WebhookEventType.SubscriptionTrialEnding,
            "subscription.upcoming_renewal" => WebhookEventType.SubscriptionUpcomingRenewal,
    ...
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                ...
                WebhookEventType.SubscriptionCancellationScheduled =>
                    "subscription.cancellation_scheduled",
                WebhookEventType.SubscriptionTrialEnding => "subscription.trial_ending",
                WebhookEventType.SubscriptionUpcomingRenewal => "subscription.upcoming_renewal",
