...
/// </summary>
public record class LocalizedPriceUpdateParams : ParamsBase
{
    ...
    public LocalizedPriceUpdateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public LocalizedPriceUpdateParams(LocalizedPriceUpdateParams localizedPriceUpdateParams)
        : base(localizedPriceUpdateParams)
    {
        this.ProductID = localizedPriceUpdateParams.ProductID;
        this.ID = localizedPriceUpdateParams.ID;

        this._rawBodyData = new(localizedPriceUpdateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static LocalizedPriceUpdateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string productID,
    ...
    public virtual bool Equals(LocalizedPriceUpdateParams? other)
    {
        if (other == null)
        {
            return false;
