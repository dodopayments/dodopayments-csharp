...
/// </summary>
public record class ProductUpdateFilesParams : ParamsBase
{
...
#pragma warning disable CS8618
        ...
        : base(productUpdateFilesParams)
    {
        ...
        this._rawBodyData = new(productUpdateFilesParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public virtual bool Equals(ProductUpdateFilesParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + string.Format("/products/{0}/files", this.ID)
        )
        {
