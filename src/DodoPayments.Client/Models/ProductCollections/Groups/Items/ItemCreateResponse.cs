...
[JsonConverter(typeof(JsonModelConverter<ItemCreateResponse, ItemCreateResponseFromRaw>))]
public sealed record class ItemCreateResponse : JsonModel
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ItemCreateResponse(ItemCreateResponse itemCreateResponse)
        : base(itemCreateResponse) { }
#pragma warning restore CS8618

    public ItemCreateResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ItemCreateResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ItemCreateResponseFromRaw.FromRawUnchecked"/>
    public static ItemCreateResponse FromRawUnchecked(
...
class ItemCreateResponseFromRaw : IFromRawJson<ItemCreateResponse>
{
    /// <inheritdoc/>
    public ItemCreateResponse FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        ItemCreateResponse.FromRawUnchecked(rawData);
}
