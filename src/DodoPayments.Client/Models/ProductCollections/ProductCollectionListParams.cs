...
/// </summary>
public record class ProductCollectionListParams : ParamsBase
{
    /// <summary>
    ...
    public ProductCollectionListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ProductCollectionListParams(ProductCollectionListParams productCollectionListParams)
        : base(productCollectionListParams) { }
...
#pragma warning restore CS8618
    ...
    public static ProductCollectionListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ProductCollectionListParams? other)
    {
        if (other == null)
        {
            return false;
