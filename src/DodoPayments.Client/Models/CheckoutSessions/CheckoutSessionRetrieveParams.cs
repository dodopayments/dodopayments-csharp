...
/// </summary>
public record class CheckoutSessionRetrieveParams : ParamsBase
{
...
#pragma warning disable CS8618
    ...
    {
        this.ID = checkoutSessionRetrieveParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static CheckoutSessionRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(CheckoutSessionRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
