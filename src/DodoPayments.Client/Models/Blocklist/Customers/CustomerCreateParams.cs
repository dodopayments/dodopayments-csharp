...
public record class CustomerCreateParams : ParamsBase
{
    ...
    public required CreateBlockedCustomerRequest CreateBlockedCustomerRequest
    {
        get
        {
            return WrappedJsonSerializer.GetNotNullClass<CreateBlockedCustomerRequest>(
                this.RawBodyData,
                "RawBodyData"
            );
        }
...
#pragma warning disable CS8618
    ...
    {
        this.RawBodyData = customerCreateParams.RawBodyData;
    }
