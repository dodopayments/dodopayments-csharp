...
///
/// <para># Responses - `200 OK` - Returns list of customer balances - `404 Not Found`
...
/// </summary>
public record class BalanceListParams : ParamsBase
{
    public string? CreditEntitlementID { get; init; }
    ...
    public BalanceListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BalanceListParams(BalanceListParams balanceListParams)
        : base(balanceListParams)
    {
        this.CreditEntitlementID = balanceListParams.CreditEntitlementID;
    }
...
#pragma warning restore CS8618
    ...
    public static BalanceListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(BalanceListParams? other)
    {
        if (other == null)
        {
            return false;
        ...
        return (
                this.CreditEntitlementID?.Equals(other.CreditEntitlementID)
                ?? other.CreditEntitlementID == null
            )
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/credit-entitlements/{0}/balances", this.CreditEntitlementID)
        )
        {
