...
/// </summary>
public record class EmailListParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public EmailListParams(EmailListParams emailListParams)
        : base(emailListParams)
    {
        this.CustomerID = emailListParams.CustomerID;
    }
...
#pragma warning restore CS8618
    ...
    public static EmailListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string customerID
    )
    ...
    public virtual bool Equals(EmailListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/customers/{0}/emails", this.CustomerID)
        )
        {
