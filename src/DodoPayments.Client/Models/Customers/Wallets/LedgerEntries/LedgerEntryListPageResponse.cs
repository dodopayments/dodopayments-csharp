        ...
        IFromRaw<LedgerEntryListPageResponse>
{
    ...
    public LedgerEntryListPageResponse(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    LedgerEntryListPageResponse(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
