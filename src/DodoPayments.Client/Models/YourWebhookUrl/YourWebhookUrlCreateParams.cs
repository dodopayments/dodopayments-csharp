...
namespace DodoPayments.Client.Models.YourWebhookUrl;
...
/// </summary>
public record class YourWebhookUrlCreateParams : ParamsBase
{
    ...
    public required string BusinessID
    {
        get
        {
            ...
            return this._rawBodyData.GetNotNullClass<string>("business_id");
        }
        init { this._rawBodyData.Set("business_id", value); }
    }
    ...
    public required Data Data
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<Data>("data");
        }
    ...
    /// </summary>
    public required ApiEnum<string, WebhookEvents::WebhookEventType> Type
    {
        get
        {
            this._rawBodyData.Freeze();
    ...
    public required string WebhookID
    {
        get
        {
            ...
            return this._rawHeaderData.GetNotNullClass<string>("webhook-id");
        }
        init { this._rawHeaderData.Set("webhook-id", value); }
    }
    ...
    public required string WebhookSignature
    {
        ...
        {
            this._rawHeaderData.Freeze();
            return this._rawHeaderData.GetNotNullClass<string>("webhook-signature");
        }
        init { this._rawHeaderData.Set("webhook-signature", value); }
    }
    ...
    public required string WebhookTimestamp
    {
        ...
        {
            this._rawHeaderData.Freeze();
            return this._rawHeaderData.GetNotNullClass<string>("webhook-timestamp");
        }
        init { this._rawHeaderData.Set("webhook-timestamp", value); }
    }

    public YourWebhookUrlCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public YourWebhookUrlCreateParams(YourWebhookUrlCreateParams yourWebhookUrlCreateParams)
        : base(yourWebhookUrlCreateParams)
    {
        this._rawBodyData = new(yourWebhookUrlCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static YourWebhookUrlCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(YourWebhookUrlCreateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/your-webhook-url")
        {
