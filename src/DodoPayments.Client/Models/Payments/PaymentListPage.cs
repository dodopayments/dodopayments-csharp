...
public sealed class PaymentListPage(
    ...
    PaymentListPageResponse response
) : IPage<PaymentListResponse>
{
    /// <inheritdoc/>
    public IReadOnlyList<PaymentListResponse> Items
    {
    ...
    /// <inheritdoc/>
    async Task<IPage<PaymentListResponse>> IPage<PaymentListResponse>.Next(
