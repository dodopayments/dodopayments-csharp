...
public sealed record class PaymentCreateResponse : JsonModel
{
    ...
    /// </summary>
    public IReadOnlyList<PaymentCreateResponseProductCart>? ProductCart
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableStruct<
                ImmutableArray<PaymentCreateResponseProductCart>
            >("product_cart");
        }
        init
        {
            this._rawData.Set<ImmutableArray<PaymentCreateResponseProductCart>?>(
                "product_cart",
...
[JsonConverter(
    typeof(JsonModelConverter<
        PaymentCreateResponseProductCart,
        PaymentCreateResponseProductCartFromRaw
    >)
)]
public sealed record class PaymentCreateResponseProductCart : JsonModel
{
    ...
    public PaymentCreateResponseProductCart() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PaymentCreateResponseProductCart(
        PaymentCreateResponseProductCart paymentCreateResponseProductCart
    )
        : base(paymentCreateResponseProductCart) { }
#pragma warning restore CS8618

    public PaymentCreateResponseProductCart(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    PaymentCreateResponseProductCart(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="PaymentCreateResponseProductCartFromRaw.FromRawUnchecked"/>
    public static PaymentCreateResponseProductCart FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class PaymentCreateResponseProductCartFromRaw : IFromRawJson<PaymentCreateResponseProductCart>
{
    /// <inheritdoc/>
    public PaymentCreateResponseProductCart FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => PaymentCreateResponseProductCart.FromRawUnchecked(rawData);
}
