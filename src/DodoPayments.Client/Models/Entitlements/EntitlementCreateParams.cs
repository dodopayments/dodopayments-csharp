...
public record class EntitlementCreateParams : ParamsBase
{
    ...
    public required IntegrationConfig IntegrationConfig
    {
        get
        {
            ...
            return this._rawBodyData.GetNotNullClass<IntegrationConfig>("integration_config");
        }
    ...
    public required ApiEnum<string, EntitlementIntegrationType> IntegrationType
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<ApiEnum<string, EntitlementIntegrationType>>(
                "integration_type"
            );
        }
        init { this._rawBodyData.Set("integration_type", value); }
    }
