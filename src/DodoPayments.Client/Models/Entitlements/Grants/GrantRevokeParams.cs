...
/// also disables the backing license key. Idempotent: re-revoking an already-revoked
/// grant returns 200 with current state. The revocation reason is always set to "manual"
/// for API-initiated revocations.
///
