...
public sealed record class SubscriptionRenewedWebhookEvent : ModelBase
{
    ...
    public required SubscriptionRenewedWebhookEventData Data
    {
        get
        {
            return ModelBase.GetNotNullClass<SubscriptionRenewedWebhookEventData>(
                this.RawData,
                "data"
            );
        }
    ...
    public required ApiEnum<string, SubscriptionRenewedWebhookEventType> Type
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, SubscriptionRenewedWebhookEventType>>(
                this.RawData,
                "type"
            );
        }
