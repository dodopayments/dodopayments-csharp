...
public sealed record class SubscriptionRenewedWebhookEvent : JsonModel
{
    ...
    public required SubscriptionRenewedWebhookEventData Data
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<SubscriptionRenewedWebhookEventData>("data");
        }
    ...
    public override void Validate()
    {
        ...
        if (
            !JsonElement.DeepEquals(
                this.Type,
                JsonSerializer.SerializeToElement("subscription.renewed")
            )
        )
        {
    ...
    {
        this.Type = JsonSerializer.SerializeToElement("subscription.renewed");
    }
...
public sealed record class SubscriptionRenewedWebhookEventData : JsonModel
{
    ...
    public static implicit operator Subscription(
        ...
        new()
        {
            ...
            BrandID = subscriptionRenewedWebhookEventData.BrandID,
            ...
            CreditEntitlementCart = subscriptionRenewedWebhookEventData.CreditEntitlementCart,
            Currency = subscriptionRenewedWebhookEventData.Currency,
            Customer = subscriptionRenewedWebhookEventData.Customer,
            HasPaymentMethod = subscriptionRenewedWebhookEventData.HasPaymentMethod,
            Metadata = subscriptionRenewedWebhookEventData.Metadata,
            MeterCreditEntitlementCart =
                subscriptionRenewedWebhookEventData.MeterCreditEntitlementCart,
            ...
            CancellationComment = subscriptionRenewedWebhookEventData.CancellationComment,
            CancellationFeedback = subscriptionRenewedWebhookEventData.CancellationFeedback,
            CancelledAt = subscriptionRenewedWebhookEventData.CancelledAt,
            CustomFieldResponses = subscriptionRenewedWebhookEventData.CustomFieldResponses,
            CustomerBusinessName = subscriptionRenewedWebhookEventData.CustomerBusinessName,
            ...
            Discounts = subscriptionRenewedWebhookEventData.Discounts,
            ExpiresAt = subscriptionRenewedWebhookEventData.ExpiresAt,
            PausedAt = subscriptionRenewedWebhookEventData.PausedAt,
            PaymentMethodID = subscriptionRenewedWebhookEventData.PaymentMethodID,
            ScheduledChange = subscriptionRenewedWebhookEventData.ScheduledChange,
            TaxID = subscriptionRenewedWebhookEventData.TaxID,
            TrialAmount = subscriptionRenewedWebhookEventData.TrialAmount,
        };
