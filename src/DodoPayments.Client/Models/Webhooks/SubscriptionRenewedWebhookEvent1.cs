        ...
        IFromRaw<SubscriptionRenewedWebhookEvent>
{
    ...
    /// Event-specific data
    /// </summary>
    public required SubscriptionRenewedWebhookEventProperties::Data Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<SubscriptionRenewedWebhookEventProperties::Data>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new DodoPaymentsInvalidDataException(
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, SubscriptionRenewedWebhookEventProperties::Type> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<
                ApiEnum<string, SubscriptionRenewedWebhookEventProperties::Type>
