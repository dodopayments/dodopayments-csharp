...
public sealed record class SubscriptionRenewedWebhookEvent : JsonModel
{
    ...
    {
        get { return JsonModel.GetNotNullClass<Data19>(this.RawData, "data"); }
...
/// Event-specific data
/// </summary>
[JsonConverter(typeof(JsonModelConverter<Data19, Data19FromRaw>))]
public sealed record class Data19 : JsonModel
{
    /// <summary>
...
class Data19FromRaw : IFromRawJson<Data19>
{
    /// <inheritdoc/>
...
[JsonConverter(
    typeof(JsonModelConverter<Data19IntersectionMember1, Data19IntersectionMember1FromRaw>)
)]
public sealed record class Data19IntersectionMember1 : JsonModel
{
    /// <summary>
    /// The type of payload in the data field
    /// </summary>
    ...
    public Data19IntersectionMember1(Data19IntersectionMember1 data19IntersectionMember1)
        : base(data19IntersectionMember1) { }
...
class Data19IntersectionMember1FromRaw : IFromRawJson<Data19IntersectionMember1>
{
    /// <inheritdoc/>
