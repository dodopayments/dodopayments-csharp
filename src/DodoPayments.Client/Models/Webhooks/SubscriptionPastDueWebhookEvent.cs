...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        SubscriptionPastDueWebhookEventFromRaw
    >)
)]
public sealed record class SubscriptionPastDueWebhookEvent : JsonModel
{
    /// <summary>
    ...
    /// </summary>
    public required SubscriptionPastDueWebhookEventData Data
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<SubscriptionPastDueWebhookEventData>("data");
        }
    ...
    public override void Validate()
    {
        ...
        if (
            !JsonElement.DeepEquals(
                this.Type,
                JsonSerializer.SerializeToElement("subscription.past_due")
            )
        )
        {
    ...
    public SubscriptionPastDueWebhookEvent()
    {
        this.Type = JsonSerializer.SerializeToElement("subscription.past_due");
    }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SubscriptionPastDueWebhookEvent(
        SubscriptionPastDueWebhookEvent subscriptionPastDueWebhookEvent
    )
        : base(subscriptionPastDueWebhookEvent) { }
#pragma warning restore CS8618

    public SubscriptionPastDueWebhookEvent(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    SubscriptionPastDueWebhookEvent(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="SubscriptionPastDueWebhookEventFromRaw.FromRawUnchecked"/>
    public static SubscriptionPastDueWebhookEvent FromRawUnchecked(
...
class SubscriptionPastDueWebhookEventFromRaw : IFromRawJson<SubscriptionPastDueWebhookEvent>
{
    /// <inheritdoc/>
    public SubscriptionPastDueWebhookEvent FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SubscriptionPastDueWebhookEvent.FromRawUnchecked(rawData);
}
...
[JsonConverter(
    typeof(JsonModelConverter<
        SubscriptionPastDueWebhookEventData,
        SubscriptionPastDueWebhookEventDataFromRaw
    >)
)]
public sealed record class SubscriptionPastDueWebhookEventData : JsonModel
{
    /// <summary>
    ...
    public static implicit operator Subscription(
        SubscriptionPastDueWebhookEventData subscriptionPastDueWebhookEventData
    ) =>
        new()
        {
            Addons = subscriptionPastDueWebhookEventData.Addons,
            Billing = subscriptionPastDueWebhookEventData.Billing,
            BrandID = subscriptionPastDueWebhookEventData.BrandID,
            CancelAtNextBillingDate = subscriptionPastDueWebhookEventData.CancelAtNextBillingDate,
            CreatedAt = subscriptionPastDueWebhookEventData.CreatedAt,
            CreditEntitlementCart = subscriptionPastDueWebhookEventData.CreditEntitlementCart,
            Currency = subscriptionPastDueWebhookEventData.Currency,
            Customer = subscriptionPastDueWebhookEventData.Customer,
            HasPaymentMethod = subscriptionPastDueWebhookEventData.HasPaymentMethod,
            Metadata = subscriptionPastDueWebhookEventData.Metadata,
            MeterCreditEntitlementCart =
                subscriptionPastDueWebhookEventData.MeterCreditEntitlementCart,
            Meters = subscriptionPastDueWebhookEventData.Meters,
            NextBillingDate = subscriptionPastDueWebhookEventData.NextBillingDate,
            OnDemand = subscriptionPastDueWebhookEventData.OnDemand,
            PaymentFrequencyCount = subscriptionPastDueWebhookEventData.PaymentFrequencyCount,
            PaymentFrequencyInterval = subscriptionPastDueWebhookEventData.PaymentFrequencyInterval,
            PreviousBillingDate = subscriptionPastDueWebhookEventData.PreviousBillingDate,
            ProductID = subscriptionPastDueWebhookEventData.ProductID,
            Quantity = subscriptionPastDueWebhookEventData.Quantity,
            RecurringPreTaxAmount = subscriptionPastDueWebhookEventData.RecurringPreTaxAmount,
            Status = subscriptionPastDueWebhookEventData.Status,
            SubscriptionID = subscriptionPastDueWebhookEventData.SubscriptionID,
            SubscriptionPeriodCount = subscriptionPastDueWebhookEventData.SubscriptionPeriodCount,
            SubscriptionPeriodInterval =
                subscriptionPastDueWebhookEventData.SubscriptionPeriodInterval,
            TaxInclusive = subscriptionPastDueWebhookEventData.TaxInclusive,
            TrialPeriodDays = subscriptionPastDueWebhookEventData.TrialPeriodDays,
            CancellationComment = subscriptionPastDueWebhookEventData.CancellationComment,
            CancellationFeedback = subscriptionPastDueWebhookEventData.CancellationFeedback,
            CancelledAt = subscriptionPastDueWebhookEventData.CancelledAt,
            CustomFieldResponses = subscriptionPastDueWebhookEventData.CustomFieldResponses,
            CustomerBusinessName = subscriptionPastDueWebhookEventData.CustomerBusinessName,
            DiscountCyclesRemaining = subscriptionPastDueWebhookEventData.DiscountCyclesRemaining,
            DiscountID = subscriptionPastDueWebhookEventData.DiscountID,
            Discounts = subscriptionPastDueWebhookEventData.Discounts,
            ExpiresAt = subscriptionPastDueWebhookEventData.ExpiresAt,
            PausedAt = subscriptionPastDueWebhookEventData.PausedAt,
            PaymentMethodID = subscriptionPastDueWebhookEventData.PaymentMethodID,
            ScheduledChange = subscriptionPastDueWebhookEventData.ScheduledChange,
            TaxID = subscriptionPastDueWebhookEventData.TaxID,
            TrialAmount = subscriptionPastDueWebhookEventData.TrialAmount,
        };
    ...
    public SubscriptionPastDueWebhookEventData() { }
...
#pragma warning disable CS8618
    ...
    public SubscriptionPastDueWebhookEventData(
        ...
        : base(subscriptionPastDueWebhookEventData) { }
#pragma warning restore CS8618

    public SubscriptionPastDueWebhookEventData(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    SubscriptionPastDueWebhookEventData(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="SubscriptionPastDueWebhookEventDataFromRaw.FromRawUnchecked"/>
    public static SubscriptionPastDueWebhookEventData FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class SubscriptionPastDueWebhookEventDataFromRaw : IFromRawJson<SubscriptionPastDueWebhookEventData>
{
    /// <inheritdoc/>
    public SubscriptionPastDueWebhookEventData FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SubscriptionPastDueWebhookEventData.FromRawUnchecked(rawData);
}

[JsonConverter(
    typeof(JsonModelConverter<
        SubscriptionPastDueWebhookEventDataIntersectionMember1,
        SubscriptionPastDueWebhookEventDataIntersectionMember1FromRaw
    >)
)]
public sealed record class SubscriptionPastDueWebhookEventDataIntersectionMember1 : JsonModel
{
    /// <summary>
    /// Time when the grace period ends. The subscription moves to `on_hold` or to
    /// `cancelled` at this time.
    ...
    public SubscriptionPastDueWebhookEventDataIntersectionMember1() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SubscriptionPastDueWebhookEventDataIntersectionMember1(
        SubscriptionPastDueWebhookEventDataIntersectionMember1 subscriptionPastDueWebhookEventDataIntersectionMember1
    )
        : base(subscriptionPastDueWebhookEventDataIntersectionMember1) { }
#pragma warning restore CS8618
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="SubscriptionPastDueWebhookEventDataIntersectionMember1FromRaw.FromRawUnchecked"/>
    public static SubscriptionPastDueWebhookEventDataIntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class SubscriptionPastDueWebhookEventDataIntersectionMember1FromRaw
    : IFromRawJson<SubscriptionPastDueWebhookEventDataIntersectionMember1>
{
    /// <inheritdoc/>
    public SubscriptionPastDueWebhookEventDataIntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SubscriptionPastDueWebhookEventDataIntersectionMember1.FromRawUnchecked(rawData);
}
