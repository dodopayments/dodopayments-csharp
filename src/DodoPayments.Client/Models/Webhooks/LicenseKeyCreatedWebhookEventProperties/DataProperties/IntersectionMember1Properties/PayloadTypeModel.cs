...
namespace DodoPayments.Client.Models.Webhooks.LicenseKeyCreatedWebhookEventProperties.DataProperties.IntersectionMember1Properties;
...
sealed class PayloadTypeModelConverter : JsonConverter<PayloadTypeModel>
{
    ...
    )
    {
        ...
        {
            "LicenseKey" => PayloadTypeModel.LicenseKey,
    ...
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                PayloadTypeModel.LicenseKey => "LicenseKey",
