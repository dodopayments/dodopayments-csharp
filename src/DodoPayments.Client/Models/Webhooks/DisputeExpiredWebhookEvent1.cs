        ...
        IFromRaw<DisputeExpiredWebhookEvent>
{
    ...
    /// Event-specific data
    /// </summary>
    public required DisputeExpiredWebhookEventProperties::Data Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<DisputeExpiredWebhookEventProperties::Data>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new DodoPaymentsInvalidDataException(
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, DisputeExpiredWebhookEventProperties::Type> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<
                ApiEnum<string, DisputeExpiredWebhookEventProperties::Type>
