...
using DodoPayments.Client.Models.Webhooks.SubscriptionCancelledWebhookEventProperties.DataProperties.IntersectionMember1Properties;
using System = System;

namespace DodoPayments.Client.Models.Webhooks.SubscriptionCancelledWebhookEventProperties;
...
public sealed record class DataModel : ModelBase, IFromRaw<DataModel>
{
    ...
    public static implicit operator Subscription(DataModel dataModel) =>
        new()
        {
            Addons = dataModel.Addons,
            Billing = dataModel.Billing,
            CancelAtNextBillingDate = dataModel.CancelAtNextBillingDate,
            CreatedAt = dataModel.CreatedAt,
            Currency = dataModel.Currency,
            Customer = dataModel.Customer,
            Metadata = dataModel.Metadata,
            Meters = dataModel.Meters,
            NextBillingDate = dataModel.NextBillingDate,
            OnDemand = dataModel.OnDemand,
            PaymentFrequencyCount = dataModel.PaymentFrequencyCount,
            PaymentFrequencyInterval = dataModel.PaymentFrequencyInterval,
            PreviousBillingDate = dataModel.PreviousBillingDate,
            ProductID = dataModel.ProductID,
            Quantity = dataModel.Quantity,
            RecurringPreTaxAmount = dataModel.RecurringPreTaxAmount,
            Status = dataModel.Status,
            SubscriptionID = dataModel.SubscriptionID,
            SubscriptionPeriodCount = dataModel.SubscriptionPeriodCount,
            SubscriptionPeriodInterval = dataModel.SubscriptionPeriodInterval,
            TaxInclusive = dataModel.TaxInclusive,
            TrialPeriodDays = dataModel.TrialPeriodDays,
            CancelledAt = dataModel.CancelledAt,
            DiscountCyclesRemaining = dataModel.DiscountCyclesRemaining,
            DiscountID = dataModel.DiscountID,
