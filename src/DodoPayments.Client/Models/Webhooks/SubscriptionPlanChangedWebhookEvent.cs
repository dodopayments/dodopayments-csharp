...
public sealed record class SubscriptionPlanChangedWebhookEvent : JsonModel
{
    ...
    public required SubscriptionPlanChangedWebhookEventData Data
    {
        get
        {
            return JsonModel.GetNotNullClass<SubscriptionPlanChangedWebhookEventData>(
                this.RawData,
                "data"
            );
        }
...
public sealed record class SubscriptionPlanChangedWebhookEventData : JsonModel
{
    /// <summary>
...
class SubscriptionPlanChangedWebhookEventDataFromRaw
    : IFromRawJson<SubscriptionPlanChangedWebhookEventData>
{
    /// <inheritdoc/>
...
public sealed record class SubscriptionPlanChangedWebhookEventDataIntersectionMember1 : JsonModel
{
    /// <summary>
    /// The type of payload in the data field
    /// </summary>
...
class SubscriptionPlanChangedWebhookEventDataIntersectionMember1FromRaw
    : IFromRawJson<SubscriptionPlanChangedWebhookEventDataIntersectionMember1>
{
    /// <inheritdoc/>
