...
public sealed record class SubscriptionPlanChangedWebhookEvent : JsonModel
{
    ...
    public required SubscriptionPlanChangedWebhookEventData Data
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<SubscriptionPlanChangedWebhookEventData>("data");
        }
...
public sealed record class SubscriptionPlanChangedWebhookEventData : JsonModel
{
    ...
    public static implicit operator Subscription(
        ...
        new()
        {
            ...
            BrandID = subscriptionPlanChangedWebhookEventData.BrandID,
            ...
            Discounts = subscriptionPlanChangedWebhookEventData.Discounts,
            ExpiresAt = subscriptionPlanChangedWebhookEventData.ExpiresAt,
            PausedAt = subscriptionPlanChangedWebhookEventData.PausedAt,
            PaymentMethodID = subscriptionPlanChangedWebhookEventData.PaymentMethodID,
            ScheduledChange = subscriptionPlanChangedWebhookEventData.ScheduledChange,
            TaxID = subscriptionPlanChangedWebhookEventData.TaxID,
            TrialAmount = subscriptionPlanChangedWebhookEventData.TrialAmount,
        };
