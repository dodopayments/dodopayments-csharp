        ...
        IFromRaw<PaymentProcessingWebhookEvent>
{
    ...
    public required Data9 Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Data9>(element, ModelBase.SerializerOptions)
                ?? throw new DodoPaymentsInvalidDataException(
                    "'data' cannot be null",
    ...
    public required ApiEnum<string, Type9> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<ApiEnum<string, Type9>>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Data30(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Data30 FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
        return new(properties);
    }
}
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    IntersectionMember130(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static IntersectionMember130 FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
        return new(properties);
    }
}
