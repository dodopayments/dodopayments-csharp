        ...
        IFromRaw<RefundSucceededWebhookEvent>
{
    ...
    /// Event-specific data
    /// </summary>
    public required RefundSucceededWebhookEventProperties::Data Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<RefundSucceededWebhookEventProperties::Data>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new DodoPaymentsInvalidDataException(
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, RefundSucceededWebhookEventProperties::Type> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<
                ApiEnum<string, RefundSucceededWebhookEventProperties::Type>
