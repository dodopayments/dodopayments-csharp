...
public sealed record class CreditRolloverForfeitedWebhookEvent : JsonModel
{
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, CreditRolloverForfeitedWebhookEventType> Type
    {
        get
        {
            this._rawData.Freeze();
...
/// The event type
/// </summary>
[JsonConverter(typeof(CreditRolloverForfeitedWebhookEventTypeConverter))]
public enum CreditRolloverForfeitedWebhookEventType
{
    CreditRolloverForfeited,
}

sealed class CreditRolloverForfeitedWebhookEventTypeConverter
    : JsonConverter<CreditRolloverForfeitedWebhookEventType>
{
    public override CreditRolloverForfeitedWebhookEventType Read(
    ...
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            ...
            _ => (CreditRolloverForfeitedWebhookEventType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        CreditRolloverForfeitedWebhookEventType value,
        JsonSerializerOptions options
    )
    {
