...
[JsonConverter(
    typeof(ModelConverter<SubscriptionFailedWebhookEvent, SubscriptionFailedWebhookEventFromRaw1>)
)]
public sealed record class SubscriptionFailedWebhookEvent : ModelBase
{
    /// <summary>
    ...
    {
        get { return ModelBase.GetNotNullClass<Data16>(this.RawData, "data"); }
    ...
    {
        get { return ModelBase.GetNotNullClass<ApiEnum<string, Type16>>(this.RawData, "type"); }
...
class SubscriptionFailedWebhookEventFromRaw1 : IFromRaw<SubscriptionFailedWebhookEvent>
{
    /// <inheritdoc/>
...
/// Event-specific data
/// </summary>
[JsonConverter(typeof(ModelConverter<Data16, Data16FromRaw>))]
public sealed record class Data16 : ModelBase
{
    /// <summary>
    ...
    /// </summary>
    public ApiEnum<string, Data16IntersectionMember1PayloadType>? PayloadType
    {
        get
        {
            return ModelBase.GetNullableClass<
                ApiEnum<string, Data16IntersectionMember1PayloadType>
    ...
    public static implicit operator Subscription(Data16 data16) =>
        new()
        {
            ...
            PaymentMethodID = data16.PaymentMethodID,
            TaxID = data16.TaxID,
        };
    ...
    public Data16(Data16 data16)
        : base(data16) { }

    public Data16(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Data16(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="Data16FromRaw.FromRawUnchecked"/>
    public static Data16 FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    }
}

class Data16FromRaw : IFromRaw<Data16>
{
    /// <inheritdoc/>
    public Data16 FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        Data16.FromRawUnchecked(rawData);
}

[JsonConverter(typeof(ModelConverter<Data16IntersectionMember1, Data16IntersectionMember1FromRaw>))]
public sealed record class Data16IntersectionMember1 : ModelBase
{
    /// <summary>
    /// The type of payload in the data field
    /// </summary>
    ...
    public Data16IntersectionMember1() { }

    public Data16IntersectionMember1(Data16IntersectionMember1 data16IntersectionMember1)
        : base(data16IntersectionMember1) { }

    public Data16IntersectionMember1(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Data16IntersectionMember1(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="Data16IntersectionMember1FromRaw.FromRawUnchecked"/>
    public static Data16IntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class Data16IntersectionMember1FromRaw : IFromRaw<Data16IntersectionMember1>
{
    /// <inheritdoc/>
    public Data16IntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => Data16IntersectionMember1.FromRawUnchecked(rawData);
}

/// <summary>
/// The type of payload in the data field
/// </summary>
[JsonConverter(typeof(Data16IntersectionMember1PayloadTypeConverter))]
public enum Data16IntersectionMember1PayloadType
{
    Subscription,
}

sealed class Data16IntersectionMember1PayloadTypeConverter
    : JsonConverter<Data16IntersectionMember1PayloadType>
{
    public override Data16IntersectionMember1PayloadType Read(
    ...
    )
    {
        ...
        {
            "Subscription" => Data16IntersectionMember1PayloadType.Subscription,
            _ => (Data16IntersectionMember1PayloadType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        Data16IntersectionMember1PayloadType value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                Data16IntersectionMember1PayloadType.Subscription => "Subscription",
