...
public sealed record class SubscriptionFailedWebhookEvent : JsonModel
{
    ...
    {
        get { return JsonModel.GetNotNullClass<Data16>(this.RawData, "data"); }
...
/// Event-specific data
/// </summary>
[JsonConverter(typeof(JsonModelConverter<Data16, Data16FromRaw>))]
public sealed record class Data16 : JsonModel
{
    /// <summary>
...
class Data16FromRaw : IFromRawJson<Data16>
{
    /// <inheritdoc/>
...
[JsonConverter(
    typeof(JsonModelConverter<Data16IntersectionMember1, Data16IntersectionMember1FromRaw>)
)]
public sealed record class Data16IntersectionMember1 : JsonModel
{
    /// <summary>
    /// The type of payload in the data field
    /// </summary>
...
class Data16IntersectionMember1FromRaw : IFromRawJson<Data16IntersectionMember1>
{
    /// <inheritdoc/>
