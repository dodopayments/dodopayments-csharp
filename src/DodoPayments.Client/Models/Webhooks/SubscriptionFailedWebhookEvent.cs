...
public sealed record class SubscriptionFailedWebhookEvent : JsonModel
{
    ...
    public required SubscriptionFailedWebhookEventData Data
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<SubscriptionFailedWebhookEventData>("data");
        }
...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        SubscriptionFailedWebhookEventDataFromRaw
    >)
)]
public sealed record class SubscriptionFailedWebhookEventData : JsonModel
{
    /// <summary>
    ...
    public static implicit operator Subscription(
        ...
        new()
        {
            ...
            BrandID = subscriptionFailedWebhookEventData.BrandID,
            ...
            CreditEntitlementCart = subscriptionFailedWebhookEventData.CreditEntitlementCart,
            Currency = subscriptionFailedWebhookEventData.Currency,
            Customer = subscriptionFailedWebhookEventData.Customer,
            HasPaymentMethod = subscriptionFailedWebhookEventData.HasPaymentMethod,
            Metadata = subscriptionFailedWebhookEventData.Metadata,
            MeterCreditEntitlementCart =
                subscriptionFailedWebhookEventData.MeterCreditEntitlementCart,
            ...
            CancellationComment = subscriptionFailedWebhookEventData.CancellationComment,
            CancellationFeedback = subscriptionFailedWebhookEventData.CancellationFeedback,
            CancelledAt = subscriptionFailedWebhookEventData.CancelledAt,
            CustomFieldResponses = subscriptionFailedWebhookEventData.CustomFieldResponses,
            CustomerBusinessName = subscriptionFailedWebhookEventData.CustomerBusinessName,
            ...
            Discounts = subscriptionFailedWebhookEventData.Discounts,
            ExpiresAt = subscriptionFailedWebhookEventData.ExpiresAt,
            PausedAt = subscriptionFailedWebhookEventData.PausedAt,
            PaymentMethodID = subscriptionFailedWebhookEventData.PaymentMethodID,
            ScheduledChange = subscriptionFailedWebhookEventData.ScheduledChange,
            TaxID = subscriptionFailedWebhookEventData.TaxID,
            TrialAmount = subscriptionFailedWebhookEventData.TrialAmount,
        };
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    SubscriptionFailedWebhookEventData(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="SubscriptionFailedWebhookEventDataFromRaw.FromRawUnchecked"/>
...
class SubscriptionFailedWebhookEventDataFromRaw : IFromRawJson<SubscriptionFailedWebhookEventData>
{
    /// <inheritdoc/>
    public SubscriptionFailedWebhookEventData FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SubscriptionFailedWebhookEventData.FromRawUnchecked(rawData);
}

[JsonConverter(
    typeof(JsonModelConverter<
        SubscriptionFailedWebhookEventDataIntersectionMember1,
        SubscriptionFailedWebhookEventDataIntersectionMember1FromRaw
    >)
)]
public sealed record class SubscriptionFailedWebhookEventDataIntersectionMember1 : JsonModel
{
    /// <summary>
    /// Time when the grace period ends. The subscription moves to `on_hold` or to
    /// `cancelled` at this time.
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="SubscriptionFailedWebhookEventDataIntersectionMember1FromRaw.FromRawUnchecked"/>
...
class SubscriptionFailedWebhookEventDataIntersectionMember1FromRaw
    : IFromRawJson<SubscriptionFailedWebhookEventDataIntersectionMember1>
{
    /// <inheritdoc/>
    public SubscriptionFailedWebhookEventDataIntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SubscriptionFailedWebhookEventDataIntersectionMember1.FromRawUnchecked(rawData);
}
