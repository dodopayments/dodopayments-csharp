        ...
        IFromRaw<SubscriptionFailedWebhookEvent>
{
    ...
    /// Event-specific data
    /// </summary>
    public required SubscriptionFailedWebhookEventProperties::Data Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<SubscriptionFailedWebhookEventProperties::Data>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new DodoPaymentsInvalidDataException(
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, SubscriptionFailedWebhookEventProperties::Type> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<
                ApiEnum<string, SubscriptionFailedWebhookEventProperties::Type>
