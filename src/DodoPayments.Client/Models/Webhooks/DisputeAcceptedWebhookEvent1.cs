        ...
        IFromRaw<DisputeAcceptedWebhookEvent>
{
    ...
    /// Event-specific data
    /// </summary>
    public required DisputeAcceptedWebhookEventProperties::Data Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<DisputeAcceptedWebhookEventProperties::Data>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new DodoPaymentsInvalidDataException(
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, DisputeAcceptedWebhookEventProperties::Type> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<
                ApiEnum<string, DisputeAcceptedWebhookEventProperties::Type>
