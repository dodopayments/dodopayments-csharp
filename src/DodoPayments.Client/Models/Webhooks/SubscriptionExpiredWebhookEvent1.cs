...
public sealed record class SubscriptionExpiredWebhookEvent : JsonModel
{
    ...
    {
        get { return JsonModel.GetNotNullClass<Data15>(this.RawData, "data"); }
...
/// Event-specific data
/// </summary>
[JsonConverter(typeof(JsonModelConverter<Data15, Data15FromRaw>))]
public sealed record class Data15 : JsonModel
{
    /// <summary>
...
class Data15FromRaw : IFromRawJson<Data15>
{
    /// <inheritdoc/>
...
[JsonConverter(
    typeof(JsonModelConverter<Data15IntersectionMember1, Data15IntersectionMember1FromRaw>)
)]
public sealed record class Data15IntersectionMember1 : JsonModel
{
    /// <summary>
    /// The type of payload in the data field
    /// </summary>
...
class Data15IntersectionMember1FromRaw : IFromRawJson<Data15IntersectionMember1>
{
    /// <inheritdoc/>
