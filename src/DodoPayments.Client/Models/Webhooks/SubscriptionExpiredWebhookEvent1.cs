        ...
        IFromRaw<SubscriptionExpiredWebhookEvent>
{
    ...
    /// Event-specific data
    /// </summary>
    public required SubscriptionExpiredWebhookEventProperties::Data Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<SubscriptionExpiredWebhookEventProperties::Data>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new DodoPaymentsInvalidDataException(
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, SubscriptionExpiredWebhookEventProperties::Type> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<
                ApiEnum<string, SubscriptionExpiredWebhookEventProperties::Type>
