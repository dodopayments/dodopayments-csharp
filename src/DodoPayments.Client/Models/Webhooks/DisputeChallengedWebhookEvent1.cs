        ...
        IFromRaw<DisputeChallengedWebhookEvent>
{
    ...
    /// Event-specific data
    /// </summary>
    public required DisputeChallengedWebhookEventProperties::Data Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<DisputeChallengedWebhookEventProperties::Data>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new DodoPaymentsInvalidDataException(
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, DisputeChallengedWebhookEventProperties::Type> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<
                ApiEnum<string, DisputeChallengedWebhookEventProperties::Type>
