...
public sealed record class DisputeLostWebhookEvent : ModelBase, IFromRaw<DisputeLostWebhookEvent>
{
    ...
    /// Event-specific data
    /// </summary>
    public required DisputeLostWebhookEventProperties::Data Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<DisputeLostWebhookEventProperties::Data>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new DodoPaymentsInvalidDataException(
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, DisputeLostWebhookEventProperties::Type> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<
                ApiEnum<string, DisputeLostWebhookEventProperties::Type>
