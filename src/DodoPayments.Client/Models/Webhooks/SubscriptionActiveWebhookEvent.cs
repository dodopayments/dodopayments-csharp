...
public sealed record class SubscriptionActiveWebhookEvent : JsonModel
{
    ...
    public required SubscriptionActiveWebhookEventData Data
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<SubscriptionActiveWebhookEventData>("data");
        }
...
public sealed record class SubscriptionActiveWebhookEventData : JsonModel
{
    ...
    public static implicit operator Subscription(
        ...
        new()
        {
            ...
            BrandID = subscriptionActiveWebhookEventData.BrandID,
            ...
            CreditEntitlementCart = subscriptionActiveWebhookEventData.CreditEntitlementCart,
            Currency = subscriptionActiveWebhookEventData.Currency,
            Customer = subscriptionActiveWebhookEventData.Customer,
            HasPaymentMethod = subscriptionActiveWebhookEventData.HasPaymentMethod,
            Metadata = subscriptionActiveWebhookEventData.Metadata,
            MeterCreditEntitlementCart =
                subscriptionActiveWebhookEventData.MeterCreditEntitlementCart,
            ...
            CancellationComment = subscriptionActiveWebhookEventData.CancellationComment,
            CancellationFeedback = subscriptionActiveWebhookEventData.CancellationFeedback,
            CancelledAt = subscriptionActiveWebhookEventData.CancelledAt,
            CustomFieldResponses = subscriptionActiveWebhookEventData.CustomFieldResponses,
            CustomerBusinessName = subscriptionActiveWebhookEventData.CustomerBusinessName,
            ...
            Discounts = subscriptionActiveWebhookEventData.Discounts,
            ExpiresAt = subscriptionActiveWebhookEventData.ExpiresAt,
            PausedAt = subscriptionActiveWebhookEventData.PausedAt,
            PaymentMethodID = subscriptionActiveWebhookEventData.PaymentMethodID,
            ScheduledChange = subscriptionActiveWebhookEventData.ScheduledChange,
            TaxID = subscriptionActiveWebhookEventData.TaxID,
            TrialAmount = subscriptionActiveWebhookEventData.TrialAmount,
        };
