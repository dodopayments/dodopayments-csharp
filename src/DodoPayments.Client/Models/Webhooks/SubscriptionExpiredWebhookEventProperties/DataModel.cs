...
using DodoPayments.Client.Models.Webhooks.SubscriptionExpiredWebhookEventProperties.DataProperties.IntersectionMember1Properties;
using System = System;

namespace DodoPayments.Client.Models.Webhooks.SubscriptionExpiredWebhookEventProperties;
