...
public sealed record class PaymentFailedWebhookEvent : ModelBase
{
    ...
    {
        get { return ModelBase.GetNotNullClass<Data8>(this.RawData, "data"); }
    ...
    {
        get { return ModelBase.GetNotNullClass<ApiEnum<string, Type8>>(this.RawData, "type"); }
...
public sealed record class Data8 : ModelBase
{
    ...
    public ApiEnum<string, Data8IntersectionMember1PayloadType>? PayloadType
    {
        get
        {
            return ModelBase.GetNullableClass<ApiEnum<string, Data8IntersectionMember1PayloadType>>(
                this.RawData,
                "payload_type"
            );
        }
