        ...
        IFromRaw<PaymentFailedWebhookEvent>
{
    ...
    /// Event-specific data
    /// </summary>
    public required PaymentFailedWebhookEventProperties::Data Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<PaymentFailedWebhookEventProperties::Data>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new DodoPaymentsInvalidDataException(
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, PaymentFailedWebhookEventProperties::Type> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<
                ApiEnum<string, PaymentFailedWebhookEventProperties::Type>
