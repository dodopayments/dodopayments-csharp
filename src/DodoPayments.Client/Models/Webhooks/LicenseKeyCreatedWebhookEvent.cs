        ...
        IFromRaw<LicenseKeyCreatedWebhookEvent>
{
    ...
    /// Event-specific data
    /// </summary>
    public required LicenseKeyCreatedWebhookEventProperties::Data Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<LicenseKeyCreatedWebhookEventProperties::Data>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new DodoPaymentsInvalidDataException(
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, LicenseKeyCreatedWebhookEventProperties::Type> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<
                ApiEnum<string, LicenseKeyCreatedWebhookEventProperties::Type>
