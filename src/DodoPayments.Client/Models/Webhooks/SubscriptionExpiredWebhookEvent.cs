...
public sealed record class SubscriptionExpiredWebhookEvent : JsonModel
{
    ...
    public required SubscriptionExpiredWebhookEventData Data
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<SubscriptionExpiredWebhookEventData>("data");
        }
    ...
    public override void Validate()
    {
        ...
        if (
            !JsonElement.DeepEquals(
                this.Type,
                JsonSerializer.SerializeToElement("subscription.expired")
            )
        )
        {
    ...
    {
        this.Type = JsonSerializer.SerializeToElement("subscription.expired");
    }
...
public sealed record class SubscriptionExpiredWebhookEventData : JsonModel
{
    ...
    public static implicit operator Subscription(
        ...
        new()
        {
            ...
            BrandID = subscriptionExpiredWebhookEventData.BrandID,
            ...
            CreditEntitlementCart = subscriptionExpiredWebhookEventData.CreditEntitlementCart,
            Currency = subscriptionExpiredWebhookEventData.Currency,
            Customer = subscriptionExpiredWebhookEventData.Customer,
            HasPaymentMethod = subscriptionExpiredWebhookEventData.HasPaymentMethod,
            Metadata = subscriptionExpiredWebhookEventData.Metadata,
            MeterCreditEntitlementCart =
                subscriptionExpiredWebhookEventData.MeterCreditEntitlementCart,
            ...
            Discounts = subscriptionExpiredWebhookEventData.Discounts,
            ExpiresAt = subscriptionExpiredWebhookEventData.ExpiresAt,
            PausedAt = subscriptionExpiredWebhookEventData.PausedAt,
            PaymentMethodID = subscriptionExpiredWebhookEventData.PaymentMethodID,
            ScheduledChange = subscriptionExpiredWebhookEventData.ScheduledChange,
            TaxID = subscriptionExpiredWebhookEventData.TaxID,
            TrialAmount = subscriptionExpiredWebhookEventData.TrialAmount,
        };
