...
namespace DodoPayments.Client.Models.Webhooks.PaymentSucceededWebhookEventProperties.DataProperties.IntersectionMember1Properties;
...
sealed class PayloadTypeModelConverter : JsonConverter<PayloadTypeModel>
{
    ...
    )
    {
        ...
        {
            "Payment" => PayloadTypeModel.Payment,
    ...
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                PayloadTypeModel.Payment => "Payment",
