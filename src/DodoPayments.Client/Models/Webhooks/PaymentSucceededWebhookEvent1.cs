...
[JsonConverter(
    typeof(ModelConverter<PaymentSucceededWebhookEvent, PaymentSucceededWebhookEventFromRaw1>)
)]
public sealed record class PaymentSucceededWebhookEvent : ModelBase
{
    /// <summary>
    ...
    /// Event-specific data
    /// </summary>
    public required Data10 Data
    {
        get { return ModelBase.GetNotNullClass<Data10>(this.RawData, "data"); }
    ...
    {
        get { return ModelBase.GetNotNullClass<ApiEnum<string, Type10>>(this.RawData, "type"); }
...
class PaymentSucceededWebhookEventFromRaw1 : IFromRaw<PaymentSucceededWebhookEvent>
{
    /// <inheritdoc/>
...
/// Event-specific data
/// </summary>
[JsonConverter(typeof(ModelConverter<Data10, Data10FromRaw>))]
public sealed record class Data10 : ModelBase
{
    ...
    /// </summary>
    public ApiEnum<string, Data10IntersectionMember1PayloadType>? PayloadType
    {
        get
        {
            return ModelBase.GetNullableClass<
                ApiEnum<string, Data10IntersectionMember1PayloadType>
    ...
    public static implicit operator Payment(Data10 data10) =>
        new()
        {
            Billing = data10.Billing,
            BrandID = data10.BrandID,
            BusinessID = data10.BusinessID,
            CreatedAt = data10.CreatedAt,
            Currency = data10.Currency,
            Customer = data10.Customer,
            DigitalProductsDelivered = data10.DigitalProductsDelivered,
            Disputes = data10.Disputes,
            Metadata = data10.Metadata,
            PaymentID = data10.PaymentID,
            Refunds = data10.Refunds,
            SettlementAmount = data10.SettlementAmount,
            SettlementCurrency = data10.SettlementCurrency,
            TotalAmount = data10.TotalAmount,
            CardIssuingCountry = data10.CardIssuingCountry,
            CardLastFour = data10.CardLastFour,
            CardNetwork = data10.CardNetwork,
            CardType = data10.CardType,
            CheckoutSessionID = data10.CheckoutSessionID,
            DiscountID = data10.DiscountID,
            ErrorCode = data10.ErrorCode,
            ErrorMessage = data10.ErrorMessage,
            InvoiceID = data10.InvoiceID,
            PaymentLink = data10.PaymentLink,
            PaymentMethod = data10.PaymentMethod,
            PaymentMethodType = data10.PaymentMethodType,
            ProductCart = data10.ProductCart,
            SettlementTax = data10.SettlementTax,
            Status = data10.Status,
            SubscriptionID = data10.SubscriptionID,
            Tax = data10.Tax,
            UpdatedAt = data10.UpdatedAt,
        };
    ...
    public Data10(Data10 data10)
        : base(data10) { }

    public Data10(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Data10(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="Data10FromRaw.FromRawUnchecked"/>
    public static Data10 FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    }
}

class Data10FromRaw : IFromRaw<Data10>
{
    /// <inheritdoc/>
    public Data10 FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        Data10.FromRawUnchecked(rawData);
}

[JsonConverter(typeof(ModelConverter<Data10IntersectionMember1, Data10IntersectionMember1FromRaw>))]
public sealed record class Data10IntersectionMember1 : ModelBase
{
    /// <summary>
    /// The type of payload in the data field
    /// </summary>
    ...
    public Data10IntersectionMember1() { }

    public Data10IntersectionMember1(Data10IntersectionMember1 data10IntersectionMember1)
        : base(data10IntersectionMember1) { }

    public Data10IntersectionMember1(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Data10IntersectionMember1(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="Data10IntersectionMember1FromRaw.FromRawUnchecked"/>
    public static Data10IntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class Data10IntersectionMember1FromRaw : IFromRaw<Data10IntersectionMember1>
{
    /// <inheritdoc/>
    public Data10IntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => Data10IntersectionMember1.FromRawUnchecked(rawData);
}

/// <summary>
/// The type of payload in the data field
/// </summary>
[JsonConverter(typeof(Data10IntersectionMember1PayloadTypeConverter))]
public enum Data10IntersectionMember1PayloadType
{
    Payment,
}

sealed class Data10IntersectionMember1PayloadTypeConverter
    : JsonConverter<Data10IntersectionMember1PayloadType>
{
    public override Data10IntersectionMember1PayloadType Read(
    ...
    )
    {
        ...
        {
            "Payment" => Data10IntersectionMember1PayloadType.Payment,
            _ => (Data10IntersectionMember1PayloadType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        Data10IntersectionMember1PayloadType value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                Data10IntersectionMember1PayloadType.Payment => "Payment",
