...
public sealed record class PaymentSucceededWebhookEvent : JsonModel
{
    ...
    {
        get { return JsonModel.GetNotNullClass<Data10>(this.RawData, "data"); }
...
/// Event-specific data
/// </summary>
[JsonConverter(typeof(JsonModelConverter<Data10, Data10FromRaw>))]
public sealed record class Data10 : JsonModel
{
...
class Data10FromRaw : IFromRawJson<Data10>
{
    /// <inheritdoc/>
...
[JsonConverter(
    typeof(JsonModelConverter<Data10IntersectionMember1, Data10IntersectionMember1FromRaw>)
)]
public sealed record class Data10IntersectionMember1 : JsonModel
{
    /// <summary>
    /// The type of payload in the data field
    /// </summary>
...
class Data10IntersectionMember1FromRaw : IFromRawJson<Data10IntersectionMember1>
{
    /// <inheritdoc/>
