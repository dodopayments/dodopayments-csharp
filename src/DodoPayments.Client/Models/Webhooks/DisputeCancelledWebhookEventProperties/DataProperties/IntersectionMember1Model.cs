...
using DodoPayments.Client.Models.Webhooks.DisputeCancelledWebhookEventProperties.DataProperties.IntersectionMember1Properties;

namespace DodoPayments.Client.Models.Webhooks.DisputeCancelledWebhookEventProperties.DataProperties;
