...
public sealed record class SubscriptionOnHoldWebhookEvent : JsonModel
{
    ...
    public required SubscriptionOnHoldWebhookEventData Data
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<SubscriptionOnHoldWebhookEventData>("data");
        }
    ...
    public override void Validate()
    {
        ...
        if (
            !JsonElement.DeepEquals(
                this.Type,
                JsonSerializer.SerializeToElement("subscription.on_hold")
            )
        )
        {
    ...
    {
        this.Type = JsonSerializer.SerializeToElement("subscription.on_hold");
    }
...
public sealed record class SubscriptionOnHoldWebhookEventData : JsonModel
{
    ...
    public static implicit operator Subscription(
        ...
        new()
        {
            ...
            BrandID = subscriptionOnHoldWebhookEventData.BrandID,
            ...
            CreditEntitlementCart = subscriptionOnHoldWebhookEventData.CreditEntitlementCart,
            Currency = subscriptionOnHoldWebhookEventData.Currency,
            Customer = subscriptionOnHoldWebhookEventData.Customer,
            HasPaymentMethod = subscriptionOnHoldWebhookEventData.HasPaymentMethod,
            Metadata = subscriptionOnHoldWebhookEventData.Metadata,
            MeterCreditEntitlementCart =
                subscriptionOnHoldWebhookEventData.MeterCreditEntitlementCart,
            ...
            CancellationComment = subscriptionOnHoldWebhookEventData.CancellationComment,
            CancellationFeedback = subscriptionOnHoldWebhookEventData.CancellationFeedback,
            CancelledAt = subscriptionOnHoldWebhookEventData.CancelledAt,
            CustomFieldResponses = subscriptionOnHoldWebhookEventData.CustomFieldResponses,
            CustomerBusinessName = subscriptionOnHoldWebhookEventData.CustomerBusinessName,
            ...
            Discounts = subscriptionOnHoldWebhookEventData.Discounts,
            ExpiresAt = subscriptionOnHoldWebhookEventData.ExpiresAt,
            PausedAt = subscriptionOnHoldWebhookEventData.PausedAt,
            PaymentMethodID = subscriptionOnHoldWebhookEventData.PaymentMethodID,
            ScheduledChange = subscriptionOnHoldWebhookEventData.ScheduledChange,
            TaxID = subscriptionOnHoldWebhookEventData.TaxID,
            TrialAmount = subscriptionOnHoldWebhookEventData.TrialAmount,
        };
