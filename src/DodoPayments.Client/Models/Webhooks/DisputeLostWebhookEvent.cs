...
public sealed record class Data3 : ModelBase, IFromRaw<Data3>
{
    ...
    /// </summary>
    public ApiEnum<string, PayloadType3>? PayloadType
    {
        get
        {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Data3(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Data3 FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
        return new(properties);
    }
}
