...
public sealed record class DisputeLostWebhookEvent : ModelBase
{
    ...
    {
        get { return ModelBase.GetNotNullClass<DisputeLostWebhookEventData>(this.RawData, "data"); }
    ...
    public required ApiEnum<string, DisputeLostWebhookEventType> Type
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, DisputeLostWebhookEventType>>(
                this.RawData,
                "type"
            );
        }
