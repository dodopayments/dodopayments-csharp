    ...
    public string BusinessID
    {
        get
        {
            return Match(
                ...
                disputeLost: (x) => x.STAINLESS_FIXME_BusinessID,
                disputeOpened: (x) => x.STAINLESS_FIXME_BusinessID,
                disputeWon: (x) => x.STAINLESS_FIXME_BusinessID,
                licenseKeyCreated: (x) => x.STAINLESS_FIXME_BusinessID,
                paymentCancelled: (x) => x.STAINLESS_FIXME_BusinessID,
                paymentFailed: (x) => x.STAINLESS_FIXME_BusinessID,
                paymentProcessing: (x) => x.STAINLESS_FIXME_BusinessID,
                paymentSucceeded: (x) => x.STAINLESS_FIXME_BusinessID,
                refundFailed: (x) => x.STAINLESS_FIXME_BusinessID,
                refundSucceeded: (x) => x.STAINLESS_FIXME_BusinessID,
                subscriptionActive: (x) => x.STAINLESS_FIXME_BusinessID,
                subscriptionCancelled: (x) => x.STAINLESS_FIXME_BusinessID,
                subscriptionExpired: (x) => x.STAINLESS_FIXME_BusinessID,
                subscriptionFailed: (x) => x.STAINLESS_FIXME_BusinessID,
                subscriptionOnHold: (x) => x.STAINLESS_FIXME_BusinessID,
                subscriptionPlanChanged: (x) => x.STAINLESS_FIXME_BusinessID,
                subscriptionRenewed: (x) => x.STAINLESS_FIXME_BusinessID,
                subscriptionUpdated: (x) => x.STAINLESS_FIXME_BusinessID
            );
        }
    }
    ...
    public System::DateTimeOffset Timestamp
    {
        get
        {
            return Match(
                ...
                disputeLost: (x) => x.STAINLESS_FIXME_Timestamp,
                disputeOpened: (x) => x.STAINLESS_FIXME_Timestamp,
                disputeWon: (x) => x.STAINLESS_FIXME_Timestamp,
                licenseKeyCreated: (x) => x.STAINLESS_FIXME_Timestamp,
                paymentCancelled: (x) => x.STAINLESS_FIXME_Timestamp,
                paymentFailed: (x) => x.STAINLESS_FIXME_Timestamp,
                paymentProcessing: (x) => x.STAINLESS_FIXME_Timestamp,
                paymentSucceeded: (x) => x.STAINLESS_FIXME_Timestamp,
                refundFailed: (x) => x.STAINLESS_FIXME_Timestamp,
                refundSucceeded: (x) => x.STAINLESS_FIXME_Timestamp,
                subscriptionActive: (x) => x.STAINLESS_FIXME_Timestamp,
                subscriptionCancelled: (x) => x.STAINLESS_FIXME_Timestamp,
                subscriptionExpired: (x) => x.STAINLESS_FIXME_Timestamp,
                subscriptionFailed: (x) => x.STAINLESS_FIXME_Timestamp,
                subscriptionOnHold: (x) => x.STAINLESS_FIXME_Timestamp,
                subscriptionPlanChanged: (x) => x.STAINLESS_FIXME_Timestamp,
                subscriptionRenewed: (x) => x.STAINLESS_FIXME_Timestamp,
