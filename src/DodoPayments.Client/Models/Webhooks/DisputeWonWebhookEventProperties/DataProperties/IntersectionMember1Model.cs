...
using DodoPayments.Client.Models.Webhooks.DisputeWonWebhookEventProperties.DataProperties.IntersectionMember1Properties;

namespace DodoPayments.Client.Models.Webhooks.DisputeWonWebhookEventProperties.DataProperties;
