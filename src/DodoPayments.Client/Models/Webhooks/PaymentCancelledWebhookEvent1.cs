...
[JsonConverter(typeof(ModelConverter<PaymentCancelledWebhookEvent>))]
public sealed record class PaymentCancelledWebhookEvent
    : ModelBase,
        IFromRaw<PaymentCancelledWebhookEvent>
{
    /// <summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    PaymentCancelledWebhookEvent(Dictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Data28(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Data28 FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
        return new(properties);
    }
}
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    IntersectionMember128(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static IntersectionMember128 FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
        return new(properties);
    }
}
