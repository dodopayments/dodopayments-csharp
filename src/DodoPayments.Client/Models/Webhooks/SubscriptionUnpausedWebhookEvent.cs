...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        SubscriptionUnpausedWebhookEventFromRaw
    >)
)]
public sealed record class SubscriptionUnpausedWebhookEvent : JsonModel
{
    /// <summary>
    ...
    /// </summary>
    public required SubscriptionUnpausedWebhookEventData Data
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<SubscriptionUnpausedWebhookEventData>("data");
        }
    ...
    public override void Validate()
    {
        ...
        if (
            !JsonElement.DeepEquals(
                this.Type,
                JsonSerializer.SerializeToElement("subscription.unpaused")
            )
        )
        {
    ...
    public SubscriptionUnpausedWebhookEvent()
    {
        this.Type = JsonSerializer.SerializeToElement("subscription.unpaused");
    }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SubscriptionUnpausedWebhookEvent(
        SubscriptionUnpausedWebhookEvent subscriptionUnpausedWebhookEvent
    )
        : base(subscriptionUnpausedWebhookEvent) { }
#pragma warning restore CS8618

    public SubscriptionUnpausedWebhookEvent(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    SubscriptionUnpausedWebhookEvent(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="SubscriptionUnpausedWebhookEventFromRaw.FromRawUnchecked"/>
    public static SubscriptionUnpausedWebhookEvent FromRawUnchecked(
...
class SubscriptionUnpausedWebhookEventFromRaw : IFromRawJson<SubscriptionUnpausedWebhookEvent>
{
    /// <inheritdoc/>
    public SubscriptionUnpausedWebhookEvent FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SubscriptionUnpausedWebhookEvent.FromRawUnchecked(rawData);
}
...
[JsonConverter(
    typeof(JsonModelConverter<
        SubscriptionUnpausedWebhookEventData,
        SubscriptionUnpausedWebhookEventDataFromRaw
    >)
)]
public sealed record class SubscriptionUnpausedWebhookEventData : JsonModel
{
    /// <summary>
    ...
    public static implicit operator Subscription(
        SubscriptionUnpausedWebhookEventData subscriptionUnpausedWebhookEventData
    ) =>
        new()
        {
            Addons = subscriptionUnpausedWebhookEventData.Addons,
            Billing = subscriptionUnpausedWebhookEventData.Billing,
            BrandID = subscriptionUnpausedWebhookEventData.BrandID,
            CancelAtNextBillingDate = subscriptionUnpausedWebhookEventData.CancelAtNextBillingDate,
            CreatedAt = subscriptionUnpausedWebhookEventData.CreatedAt,
            CreditEntitlementCart = subscriptionUnpausedWebhookEventData.CreditEntitlementCart,
            Currency = subscriptionUnpausedWebhookEventData.Currency,
            Customer = subscriptionUnpausedWebhookEventData.Customer,
            HasPaymentMethod = subscriptionUnpausedWebhookEventData.HasPaymentMethod,
            Metadata = subscriptionUnpausedWebhookEventData.Metadata,
            MeterCreditEntitlementCart =
                subscriptionUnpausedWebhookEventData.MeterCreditEntitlementCart,
            Meters = subscriptionUnpausedWebhookEventData.Meters,
            NextBillingDate = subscriptionUnpausedWebhookEventData.NextBillingDate,
            OnDemand = subscriptionUnpausedWebhookEventData.OnDemand,
            PaymentFrequencyCount = subscriptionUnpausedWebhookEventData.PaymentFrequencyCount,
            PaymentFrequencyInterval =
                subscriptionUnpausedWebhookEventData.PaymentFrequencyInterval,
            PreviousBillingDate = subscriptionUnpausedWebhookEventData.PreviousBillingDate,
            ProductID = subscriptionUnpausedWebhookEventData.ProductID,
            Quantity = subscriptionUnpausedWebhookEventData.Quantity,
            RecurringPreTaxAmount = subscriptionUnpausedWebhookEventData.RecurringPreTaxAmount,
            Status = subscriptionUnpausedWebhookEventData.Status,
            SubscriptionID = subscriptionUnpausedWebhookEventData.SubscriptionID,
            SubscriptionPeriodCount = subscriptionUnpausedWebhookEventData.SubscriptionPeriodCount,
            SubscriptionPeriodInterval =
                subscriptionUnpausedWebhookEventData.SubscriptionPeriodInterval,
            TaxInclusive = subscriptionUnpausedWebhookEventData.TaxInclusive,
            TrialPeriodDays = subscriptionUnpausedWebhookEventData.TrialPeriodDays,
            CancellationComment = subscriptionUnpausedWebhookEventData.CancellationComment,
            CancellationFeedback = subscriptionUnpausedWebhookEventData.CancellationFeedback,
            CancelledAt = subscriptionUnpausedWebhookEventData.CancelledAt,
            CustomFieldResponses = subscriptionUnpausedWebhookEventData.CustomFieldResponses,
            CustomerBusinessName = subscriptionUnpausedWebhookEventData.CustomerBusinessName,
            DiscountCyclesRemaining = subscriptionUnpausedWebhookEventData.DiscountCyclesRemaining,
            DiscountID = subscriptionUnpausedWebhookEventData.DiscountID,
            Discounts = subscriptionUnpausedWebhookEventData.Discounts,
            ExpiresAt = subscriptionUnpausedWebhookEventData.ExpiresAt,
            PausedAt = subscriptionUnpausedWebhookEventData.PausedAt,
            PaymentMethodID = subscriptionUnpausedWebhookEventData.PaymentMethodID,
            ScheduledChange = subscriptionUnpausedWebhookEventData.ScheduledChange,
            TaxID = subscriptionUnpausedWebhookEventData.TaxID,
            TrialAmount = subscriptionUnpausedWebhookEventData.TrialAmount,
        };
    ...
    public SubscriptionUnpausedWebhookEventData() { }
...
#pragma warning disable CS8618
    ...
    public SubscriptionUnpausedWebhookEventData(
        ...
        : base(subscriptionUnpausedWebhookEventData) { }
#pragma warning restore CS8618

    public SubscriptionUnpausedWebhookEventData(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    SubscriptionUnpausedWebhookEventData(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="SubscriptionUnpausedWebhookEventDataFromRaw.FromRawUnchecked"/>
    public static SubscriptionUnpausedWebhookEventData FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class SubscriptionUnpausedWebhookEventDataFromRaw
    : IFromRawJson<SubscriptionUnpausedWebhookEventData>
{
    /// <inheritdoc/>
    public SubscriptionUnpausedWebhookEventData FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SubscriptionUnpausedWebhookEventData.FromRawUnchecked(rawData);
}

[JsonConverter(
    typeof(JsonModelConverter<
        SubscriptionUnpausedWebhookEventDataIntersectionMember1,
        SubscriptionUnpausedWebhookEventDataIntersectionMember1FromRaw
    >)
)]
public sealed record class SubscriptionUnpausedWebhookEventDataIntersectionMember1 : JsonModel
{
    /// <summary>
    /// Time when the grace period ends. The subscription moves to `on_hold` or to
    /// `cancelled` at this time.
    ...
    public SubscriptionUnpausedWebhookEventDataIntersectionMember1() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SubscriptionUnpausedWebhookEventDataIntersectionMember1(
        SubscriptionUnpausedWebhookEventDataIntersectionMember1 subscriptionUnpausedWebhookEventDataIntersectionMember1
    )
        : base(subscriptionUnpausedWebhookEventDataIntersectionMember1) { }
#pragma warning restore CS8618
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="SubscriptionUnpausedWebhookEventDataIntersectionMember1FromRaw.FromRawUnchecked"/>
    public static SubscriptionUnpausedWebhookEventDataIntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class SubscriptionUnpausedWebhookEventDataIntersectionMember1FromRaw
    : IFromRawJson<SubscriptionUnpausedWebhookEventDataIntersectionMember1>
{
    /// <inheritdoc/>
    public SubscriptionUnpausedWebhookEventDataIntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SubscriptionUnpausedWebhookEventDataIntersectionMember1.FromRawUnchecked(rawData);
}
