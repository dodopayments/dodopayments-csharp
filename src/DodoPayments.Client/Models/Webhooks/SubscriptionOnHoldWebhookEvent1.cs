...
public sealed record class SubscriptionOnHoldWebhookEvent : JsonModel
{
    ...
    {
        get { return JsonModel.GetNotNullClass<Data17>(this.RawData, "data"); }
...
/// Event-specific data
/// </summary>
[JsonConverter(typeof(JsonModelConverter<Data17, Data17FromRaw>))]
public sealed record class Data17 : JsonModel
{
    /// <summary>
...
class Data17FromRaw : IFromRawJson<Data17>
{
    /// <inheritdoc/>
...
[JsonConverter(
    typeof(JsonModelConverter<Data17IntersectionMember1, Data17IntersectionMember1FromRaw>)
)]
public sealed record class Data17IntersectionMember1 : JsonModel
{
    /// <summary>
    /// The type of payload in the data field
    /// </summary>
...
class Data17IntersectionMember1FromRaw : IFromRawJson<Data17IntersectionMember1>
{
    /// <inheritdoc/>
