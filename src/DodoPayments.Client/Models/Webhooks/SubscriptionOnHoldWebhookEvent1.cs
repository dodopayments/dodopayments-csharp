        ...
        IFromRaw<SubscriptionOnHoldWebhookEvent>
{
    ...
    /// Event-specific data
    /// </summary>
    public required SubscriptionOnHoldWebhookEventProperties::Data Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<SubscriptionOnHoldWebhookEventProperties::Data>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new DodoPaymentsInvalidDataException(
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, SubscriptionOnHoldWebhookEventProperties::Type> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<
                ApiEnum<string, SubscriptionOnHoldWebhookEventProperties::Type>
