...
public sealed record class SubscriptionUpdatePaymentMethodWebhookEvent : JsonModel
{
    ...
    /// </summary>
    public required SubscriptionUpdatePaymentMethodWebhookEventData Data
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<SubscriptionUpdatePaymentMethodWebhookEventData>(
                "data"
            );
        }
...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        SubscriptionUpdatePaymentMethodWebhookEventDataFromRaw
    >)
)]
public sealed record class SubscriptionUpdatePaymentMethodWebhookEventData : JsonModel
{
    /// <summary>
    ...
    public static implicit operator Subscription(
        SubscriptionUpdatePaymentMethodWebhookEventData subscriptionUpdatePaymentMethodWebhookEventData
    ) =>
        new()
        {
            Addons = subscriptionUpdatePaymentMethodWebhookEventData.Addons,
            Billing = subscriptionUpdatePaymentMethodWebhookEventData.Billing,
            BrandID = subscriptionUpdatePaymentMethodWebhookEventData.BrandID,
            CancelAtNextBillingDate =
                subscriptionUpdatePaymentMethodWebhookEventData.CancelAtNextBillingDate,
            CreatedAt = subscriptionUpdatePaymentMethodWebhookEventData.CreatedAt,
            CreditEntitlementCart =
                subscriptionUpdatePaymentMethodWebhookEventData.CreditEntitlementCart,
            Currency = subscriptionUpdatePaymentMethodWebhookEventData.Currency,
            Customer = subscriptionUpdatePaymentMethodWebhookEventData.Customer,
            HasPaymentMethod = subscriptionUpdatePaymentMethodWebhookEventData.HasPaymentMethod,
            Metadata = subscriptionUpdatePaymentMethodWebhookEventData.Metadata,
            MeterCreditEntitlementCart =
                subscriptionUpdatePaymentMethodWebhookEventData.MeterCreditEntitlementCart,
            Meters = subscriptionUpdatePaymentMethodWebhookEventData.Meters,
            NextBillingDate = subscriptionUpdatePaymentMethodWebhookEventData.NextBillingDate,
            OnDemand = subscriptionUpdatePaymentMethodWebhookEventData.OnDemand,
            PaymentFrequencyCount =
                subscriptionUpdatePaymentMethodWebhookEventData.PaymentFrequencyCount,
            PaymentFrequencyInterval =
                subscriptionUpdatePaymentMethodWebhookEventData.PaymentFrequencyInterval,
            PreviousBillingDate =
                subscriptionUpdatePaymentMethodWebhookEventData.PreviousBillingDate,
            ProductID = subscriptionUpdatePaymentMethodWebhookEventData.ProductID,
            Quantity = subscriptionUpdatePaymentMethodWebhookEventData.Quantity,
            RecurringPreTaxAmount =
                subscriptionUpdatePaymentMethodWebhookEventData.RecurringPreTaxAmount,
            Status = subscriptionUpdatePaymentMethodWebhookEventData.Status,
            SubscriptionID = subscriptionUpdatePaymentMethodWebhookEventData.SubscriptionID,
            SubscriptionPeriodCount =
                subscriptionUpdatePaymentMethodWebhookEventData.SubscriptionPeriodCount,
            SubscriptionPeriodInterval =
                subscriptionUpdatePaymentMethodWebhookEventData.SubscriptionPeriodInterval,
            TaxInclusive = subscriptionUpdatePaymentMethodWebhookEventData.TaxInclusive,
            TrialPeriodDays = subscriptionUpdatePaymentMethodWebhookEventData.TrialPeriodDays,
            CancellationComment =
                subscriptionUpdatePaymentMethodWebhookEventData.CancellationComment,
            ...
            CustomerBusinessName =
                subscriptionUpdatePaymentMethodWebhookEventData.CustomerBusinessName,
            DiscountCyclesRemaining =
                subscriptionUpdatePaymentMethodWebhookEventData.DiscountCyclesRemaining,
            DiscountID = subscriptionUpdatePaymentMethodWebhookEventData.DiscountID,
            Discounts = subscriptionUpdatePaymentMethodWebhookEventData.Discounts,
            ExpiresAt = subscriptionUpdatePaymentMethodWebhookEventData.ExpiresAt,
            PausedAt = subscriptionUpdatePaymentMethodWebhookEventData.PausedAt,
            PaymentMethodID = subscriptionUpdatePaymentMethodWebhookEventData.PaymentMethodID,
            ScheduledChange = subscriptionUpdatePaymentMethodWebhookEventData.ScheduledChange,
            TaxID = subscriptionUpdatePaymentMethodWebhookEventData.TaxID,
            TrialAmount = subscriptionUpdatePaymentMethodWebhookEventData.TrialAmount,
        };
    ...
    public SubscriptionUpdatePaymentMethodWebhookEventData() { }
...
#pragma warning disable CS8618
    ...
    public SubscriptionUpdatePaymentMethodWebhookEventData(
        ...
        : base(subscriptionUpdatePaymentMethodWebhookEventData) { }
#pragma warning restore CS8618
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    SubscriptionUpdatePaymentMethodWebhookEventData(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="SubscriptionUpdatePaymentMethodWebhookEventDataFromRaw.FromRawUnchecked"/>
    public static SubscriptionUpdatePaymentMethodWebhookEventData FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class SubscriptionUpdatePaymentMethodWebhookEventDataFromRaw
    : IFromRawJson<SubscriptionUpdatePaymentMethodWebhookEventData>
{
    /// <inheritdoc/>
    public SubscriptionUpdatePaymentMethodWebhookEventData FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SubscriptionUpdatePaymentMethodWebhookEventData.FromRawUnchecked(rawData);
}

[JsonConverter(
    typeof(JsonModelConverter<
        SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1,
        SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1FromRaw
    >)
)]
public sealed record class SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1
    : JsonModel
{
    /// <summary>
    /// Time when the grace period ends. The subscription moves to `on_hold` or to
    ...
    public SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1(
        SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1 subscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1
    )
        : base(subscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1) { }
#pragma warning restore CS8618
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1FromRaw.FromRawUnchecked"/>
    public static SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1FromRaw
    : IFromRawJson<SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1>
{
    /// <inheritdoc/>
    public SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) =>
        SubscriptionUpdatePaymentMethodWebhookEventDataIntersectionMember1.FromRawUnchecked(
            rawData
        );
}
