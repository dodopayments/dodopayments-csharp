...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        SubscriptionPausedWebhookEventFromRaw
    >)
)]
public sealed record class SubscriptionPausedWebhookEvent : JsonModel
{
    /// <summary>
    ...
    /// </summary>
    public required SubscriptionPausedWebhookEventData Data
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<SubscriptionPausedWebhookEventData>("data");
        }
    ...
    public override void Validate()
    {
        ...
        if (
            !JsonElement.DeepEquals(
                this.Type,
                JsonSerializer.SerializeToElement("subscription.paused")
            )
        )
        {
    ...
    public SubscriptionPausedWebhookEvent()
    {
        this.Type = JsonSerializer.SerializeToElement("subscription.paused");
    }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SubscriptionPausedWebhookEvent(
        SubscriptionPausedWebhookEvent subscriptionPausedWebhookEvent
    )
        : base(subscriptionPausedWebhookEvent) { }
#pragma warning restore CS8618

    public SubscriptionPausedWebhookEvent(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    SubscriptionPausedWebhookEvent(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="SubscriptionPausedWebhookEventFromRaw.FromRawUnchecked"/>
    public static SubscriptionPausedWebhookEvent FromRawUnchecked(
...
class SubscriptionPausedWebhookEventFromRaw : IFromRawJson<SubscriptionPausedWebhookEvent>
{
    /// <inheritdoc/>
    public SubscriptionPausedWebhookEvent FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SubscriptionPausedWebhookEvent.FromRawUnchecked(rawData);
}
...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        SubscriptionPausedWebhookEventDataFromRaw
    >)
)]
public sealed record class SubscriptionPausedWebhookEventData : JsonModel
{
    /// <summary>
    ...
    public static implicit operator Subscription(
        SubscriptionPausedWebhookEventData subscriptionPausedWebhookEventData
    ) =>
        new()
        {
            Addons = subscriptionPausedWebhookEventData.Addons,
            Billing = subscriptionPausedWebhookEventData.Billing,
            BrandID = subscriptionPausedWebhookEventData.BrandID,
            CancelAtNextBillingDate = subscriptionPausedWebhookEventData.CancelAtNextBillingDate,
            CreatedAt = subscriptionPausedWebhookEventData.CreatedAt,
            CreditEntitlementCart = subscriptionPausedWebhookEventData.CreditEntitlementCart,
            Currency = subscriptionPausedWebhookEventData.Currency,
            Customer = subscriptionPausedWebhookEventData.Customer,
            HasPaymentMethod = subscriptionPausedWebhookEventData.HasPaymentMethod,
            Metadata = subscriptionPausedWebhookEventData.Metadata,
            MeterCreditEntitlementCart =
                subscriptionPausedWebhookEventData.MeterCreditEntitlementCart,
            Meters = subscriptionPausedWebhookEventData.Meters,
            NextBillingDate = subscriptionPausedWebhookEventData.NextBillingDate,
            OnDemand = subscriptionPausedWebhookEventData.OnDemand,
            PaymentFrequencyCount = subscriptionPausedWebhookEventData.PaymentFrequencyCount,
            PaymentFrequencyInterval = subscriptionPausedWebhookEventData.PaymentFrequencyInterval,
            PreviousBillingDate = subscriptionPausedWebhookEventData.PreviousBillingDate,
            ProductID = subscriptionPausedWebhookEventData.ProductID,
            Quantity = subscriptionPausedWebhookEventData.Quantity,
            RecurringPreTaxAmount = subscriptionPausedWebhookEventData.RecurringPreTaxAmount,
            Status = subscriptionPausedWebhookEventData.Status,
            SubscriptionID = subscriptionPausedWebhookEventData.SubscriptionID,
            SubscriptionPeriodCount = subscriptionPausedWebhookEventData.SubscriptionPeriodCount,
            SubscriptionPeriodInterval =
                subscriptionPausedWebhookEventData.SubscriptionPeriodInterval,
            TaxInclusive = subscriptionPausedWebhookEventData.TaxInclusive,
            TrialPeriodDays = subscriptionPausedWebhookEventData.TrialPeriodDays,
            CancellationComment = subscriptionPausedWebhookEventData.CancellationComment,
            CancellationFeedback = subscriptionPausedWebhookEventData.CancellationFeedback,
            CancelledAt = subscriptionPausedWebhookEventData.CancelledAt,
            CustomFieldResponses = subscriptionPausedWebhookEventData.CustomFieldResponses,
            CustomerBusinessName = subscriptionPausedWebhookEventData.CustomerBusinessName,
            DiscountCyclesRemaining = subscriptionPausedWebhookEventData.DiscountCyclesRemaining,
            DiscountID = subscriptionPausedWebhookEventData.DiscountID,
            Discounts = subscriptionPausedWebhookEventData.Discounts,
            ExpiresAt = subscriptionPausedWebhookEventData.ExpiresAt,
            PausedAt = subscriptionPausedWebhookEventData.PausedAt,
            PaymentMethodID = subscriptionPausedWebhookEventData.PaymentMethodID,
            ScheduledChange = subscriptionPausedWebhookEventData.ScheduledChange,
            TaxID = subscriptionPausedWebhookEventData.TaxID,
            TrialAmount = subscriptionPausedWebhookEventData.TrialAmount,
        };
    ...
    public SubscriptionPausedWebhookEventData() { }
...
#pragma warning disable CS8618
    ...
    public SubscriptionPausedWebhookEventData(
        ...
        : base(subscriptionPausedWebhookEventData) { }
#pragma warning restore CS8618

    public SubscriptionPausedWebhookEventData(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    SubscriptionPausedWebhookEventData(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="SubscriptionPausedWebhookEventDataFromRaw.FromRawUnchecked"/>
    public static SubscriptionPausedWebhookEventData FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class SubscriptionPausedWebhookEventDataFromRaw : IFromRawJson<SubscriptionPausedWebhookEventData>
{
    /// <inheritdoc/>
    public SubscriptionPausedWebhookEventData FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SubscriptionPausedWebhookEventData.FromRawUnchecked(rawData);
}

[JsonConverter(
    typeof(JsonModelConverter<
        SubscriptionPausedWebhookEventDataIntersectionMember1,
        SubscriptionPausedWebhookEventDataIntersectionMember1FromRaw
    >)
)]
public sealed record class SubscriptionPausedWebhookEventDataIntersectionMember1 : JsonModel
{
    /// <summary>
    /// Time when the grace period ends. The subscription moves to `on_hold` or to
    /// `cancelled` at this time.
    ...
    public SubscriptionPausedWebhookEventDataIntersectionMember1() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SubscriptionPausedWebhookEventDataIntersectionMember1(
        SubscriptionPausedWebhookEventDataIntersectionMember1 subscriptionPausedWebhookEventDataIntersectionMember1
    )
        : base(subscriptionPausedWebhookEventDataIntersectionMember1) { }
#pragma warning restore CS8618
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="SubscriptionPausedWebhookEventDataIntersectionMember1FromRaw.FromRawUnchecked"/>
    public static SubscriptionPausedWebhookEventDataIntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class SubscriptionPausedWebhookEventDataIntersectionMember1FromRaw
    : IFromRawJson<SubscriptionPausedWebhookEventDataIntersectionMember1>
{
    /// <inheritdoc/>
    public SubscriptionPausedWebhookEventDataIntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SubscriptionPausedWebhookEventDataIntersectionMember1.FromRawUnchecked(rawData);
}
