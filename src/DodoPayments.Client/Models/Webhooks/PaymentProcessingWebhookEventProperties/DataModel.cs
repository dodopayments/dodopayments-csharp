...
using DodoPayments.Client.Models.Webhooks.PaymentProcessingWebhookEventProperties.DataProperties.IntersectionMember1Properties;
using System = System;

namespace DodoPayments.Client.Models.Webhooks.PaymentProcessingWebhookEventProperties;
...
public sealed record class DataModel : ModelBase, IFromRaw<DataModel>
{
    ...
    public static implicit operator Payment(DataModel dataModel) =>
        new()
        {
            Billing = dataModel.Billing,
            BrandID = dataModel.BrandID,
            BusinessID = dataModel.BusinessID,
            CreatedAt = dataModel.CreatedAt,
            Currency = dataModel.Currency,
            Customer = dataModel.Customer,
            DigitalProductsDelivered = dataModel.DigitalProductsDelivered,
            Disputes = dataModel.Disputes,
            Metadata = dataModel.Metadata,
            PaymentID = dataModel.PaymentID,
            Refunds = dataModel.Refunds,
            SettlementAmount = dataModel.SettlementAmount,
            SettlementCurrency = dataModel.SettlementCurrency,
            TotalAmount = dataModel.TotalAmount,
            CardIssuingCountry = dataModel.CardIssuingCountry,
            CardLastFour = dataModel.CardLastFour,
            CardNetwork = dataModel.CardNetwork,
            CardType = dataModel.CardType,
            CheckoutSessionID = dataModel.CheckoutSessionID,
            DiscountID = dataModel.DiscountID,
            ErrorCode = dataModel.ErrorCode,
            ErrorMessage = dataModel.ErrorMessage,
            PaymentLink = dataModel.PaymentLink,
            PaymentMethod = dataModel.PaymentMethod,
            PaymentMethodType = dataModel.PaymentMethodType,
            ProductCart = dataModel.ProductCart,
            SettlementTax = dataModel.SettlementTax,
