        ...
        IFromRaw<SubscriptionActiveWebhookEvent>
{
    ...
    /// Event-specific data
    /// </summary>
    public required SubscriptionActiveWebhookEventProperties::Data Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<SubscriptionActiveWebhookEventProperties::Data>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new DodoPaymentsInvalidDataException(
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, SubscriptionActiveWebhookEventProperties::Type> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<
                ApiEnum<string, SubscriptionActiveWebhookEventProperties::Type>
