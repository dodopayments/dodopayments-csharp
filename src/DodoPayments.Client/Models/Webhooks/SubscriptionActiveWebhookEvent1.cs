...
public sealed record class SubscriptionActiveWebhookEvent : JsonModel
{
    ...
    {
        get { return JsonModel.GetNotNullClass<Data13>(this.RawData, "data"); }
...
/// Event-specific data
/// </summary>
[JsonConverter(typeof(JsonModelConverter<Data13, Data13FromRaw>))]
public sealed record class Data13 : JsonModel
{
    /// <summary>
...
class Data13FromRaw : IFromRawJson<Data13>
{
    /// <inheritdoc/>
...
[JsonConverter(
    typeof(JsonModelConverter<Data13IntersectionMember1, Data13IntersectionMember1FromRaw>)
)]
public sealed record class Data13IntersectionMember1 : JsonModel
{
    /// <summary>
    /// The type of payload in the data field
    /// </summary>
...
class Data13IntersectionMember1FromRaw : IFromRawJson<Data13IntersectionMember1>
{
    /// <inheritdoc/>
