...
[JsonConverter(
    typeof(ModelConverter<SubscriptionActiveWebhookEvent, SubscriptionActiveWebhookEventFromRaw1>)
)]
public sealed record class SubscriptionActiveWebhookEvent : ModelBase
{
    ...
    /// Event-specific data
    /// </summary>
    public required Data13 Data
    {
        get { return ModelBase.GetNotNullClass<Data13>(this.RawData, "data"); }
    ...
    {
        get { return ModelBase.GetNotNullClass<ApiEnum<string, Type13>>(this.RawData, "type"); }
...
class SubscriptionActiveWebhookEventFromRaw1 : IFromRaw<SubscriptionActiveWebhookEvent>
{
    /// <inheritdoc/>
...
/// Event-specific data
/// </summary>
[JsonConverter(typeof(ModelConverter<Data13, Data13FromRaw>))]
public sealed record class Data13 : ModelBase
{
    /// <summary>
    ...
    /// </summary>
    public ApiEnum<string, Data13IntersectionMember1PayloadType>? PayloadType
    {
        get
        {
            return ModelBase.GetNullableClass<
                ApiEnum<string, Data13IntersectionMember1PayloadType>
    ...
    public static implicit operator Subscription(Data13 data13) =>
        new()
        {
            Addons = data13.Addons,
            Billing = data13.Billing,
            CancelAtNextBillingDate = data13.CancelAtNextBillingDate,
            CreatedAt = data13.CreatedAt,
            Currency = data13.Currency,
            Customer = data13.Customer,
            Metadata = data13.Metadata,
            Meters = data13.Meters,
            NextBillingDate = data13.NextBillingDate,
            OnDemand = data13.OnDemand,
            PaymentFrequencyCount = data13.PaymentFrequencyCount,
            PaymentFrequencyInterval = data13.PaymentFrequencyInterval,
            PreviousBillingDate = data13.PreviousBillingDate,
            ProductID = data13.ProductID,
            Quantity = data13.Quantity,
            RecurringPreTaxAmount = data13.RecurringPreTaxAmount,
            Status = data13.Status,
            SubscriptionID = data13.SubscriptionID,
            SubscriptionPeriodCount = data13.SubscriptionPeriodCount,
            SubscriptionPeriodInterval = data13.SubscriptionPeriodInterval,
            TaxInclusive = data13.TaxInclusive,
            TrialPeriodDays = data13.TrialPeriodDays,
            CancelledAt = data13.CancelledAt,
            DiscountCyclesRemaining = data13.DiscountCyclesRemaining,
            DiscountID = data13.DiscountID,
            ExpiresAt = data13.ExpiresAt,
            PaymentMethodID = data13.PaymentMethodID,
            TaxID = data13.TaxID,
        };
    ...
    public Data13(Data13 data13)
        : base(data13) { }

    public Data13(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Data13(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="Data13FromRaw.FromRawUnchecked"/>
    public static Data13 FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    }
}

class Data13FromRaw : IFromRaw<Data13>
{
    /// <inheritdoc/>
    public Data13 FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        Data13.FromRawUnchecked(rawData);
}

[JsonConverter(typeof(ModelConverter<Data13IntersectionMember1, Data13IntersectionMember1FromRaw>))]
public sealed record class Data13IntersectionMember1 : ModelBase
{
    /// <summary>
    /// The type of payload in the data field
    /// </summary>
    ...
    public Data13IntersectionMember1() { }

    public Data13IntersectionMember1(Data13IntersectionMember1 data13IntersectionMember1)
        : base(data13IntersectionMember1) { }

    public Data13IntersectionMember1(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Data13IntersectionMember1(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="Data13IntersectionMember1FromRaw.FromRawUnchecked"/>
    public static Data13IntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class Data13IntersectionMember1FromRaw : IFromRaw<Data13IntersectionMember1>
{
    /// <inheritdoc/>
    public Data13IntersectionMember1 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => Data13IntersectionMember1.FromRawUnchecked(rawData);
}

/// <summary>
/// The type of payload in the data field
/// </summary>
[JsonConverter(typeof(Data13IntersectionMember1PayloadTypeConverter))]
public enum Data13IntersectionMember1PayloadType
{
    Subscription,
}

sealed class Data13IntersectionMember1PayloadTypeConverter
    : JsonConverter<Data13IntersectionMember1PayloadType>
{
    public override Data13IntersectionMember1PayloadType Read(
    ...
    )
    {
        ...
        {
            "Subscription" => Data13IntersectionMember1PayloadType.Subscription,
            _ => (Data13IntersectionMember1PayloadType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        Data13IntersectionMember1PayloadType value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                Data13IntersectionMember1PayloadType.Subscription => "Subscription",
