...
public sealed record class PaymentCancelledWebhookEvent : JsonModel
{
    ...
    public required PaymentCancelledWebhookEventData Data
    {
        get
        {
            return JsonModel.GetNotNullClass<PaymentCancelledWebhookEventData>(
                this.RawData,
                "data"
            );
        }
    ...
    public required ApiEnum<string, PaymentCancelledWebhookEventType> Type
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, PaymentCancelledWebhookEventType>>(
                this.RawData,
                "type"
            );
        }
...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        PaymentCancelledWebhookEventDataFromRaw
    >)
)]
public sealed record class PaymentCancelledWebhookEventData : JsonModel
{
    ...
    >? PayloadType
    {
        get
        {
            return JsonModel.GetNullableClass<
                ApiEnum<string, PaymentCancelledWebhookEventDataIntersectionMember1PayloadType>
    ...
    public static implicit operator Payment(
        ...
        new()
        {
            ...
            InvoiceID = paymentCancelledWebhookEventData.InvoiceID,
    ...
    public PaymentCancelledWebhookEventData(
        ...
        : base(paymentCancelledWebhookEventData) { }

    public PaymentCancelledWebhookEventData(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    PaymentCancelledWebhookEventData(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
#pragma warning restore CS8618
...
class PaymentCancelledWebhookEventDataFromRaw : IFromRawJson<PaymentCancelledWebhookEventData>
{
    /// <inheritdoc/>
...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        PaymentCancelledWebhookEventDataIntersectionMember1FromRaw
    >)
)]
public sealed record class PaymentCancelledWebhookEventDataIntersectionMember1 : JsonModel
{
    /// <summary>
    /// The type of payload in the data field
    /// </summary>
    ...
    public PaymentCancelledWebhookEventDataIntersectionMember1(
        PaymentCancelledWebhookEventDataIntersectionMember1 paymentCancelledWebhookEventDataIntersectionMember1
    )
        : base(paymentCancelledWebhookEventDataIntersectionMember1) { }
...
class PaymentCancelledWebhookEventDataIntersectionMember1FromRaw
    : IFromRawJson<PaymentCancelledWebhookEventDataIntersectionMember1>
{
    /// <inheritdoc/>
