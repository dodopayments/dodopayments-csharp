        ...
        IFromRaw<PaymentCancelledWebhookEvent>
{
    ...
    /// Event-specific data
    /// </summary>
    public required PaymentCancelledWebhookEventProperties::Data Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<PaymentCancelledWebhookEventProperties::Data>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new DodoPaymentsInvalidDataException(
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, PaymentCancelledWebhookEventProperties::Type> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<
                ApiEnum<string, PaymentCancelledWebhookEventProperties::Type>
