...
[JsonConverter(
    typeof(ModelConverter<PaymentCancelledWebhookEvent, PaymentCancelledWebhookEventFromRaw>)
)]
public sealed record class PaymentCancelledWebhookEvent : ModelBase
{
    ...
    public required PaymentCancelledWebhookEventData Data
    {
        get
        {
            return ModelBase.GetNotNullClass<PaymentCancelledWebhookEventData>(
                this.RawData,
                "data"
            );
        }
    ...
    public required ApiEnum<string, PaymentCancelledWebhookEventType> Type
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, PaymentCancelledWebhookEventType>>(
                this.RawData,
                "type"
            );
        }
...
public sealed record class PaymentCancelledWebhookEventData : ModelBase
{
...
public sealed record class PaymentCancelledWebhookEventDataIntersectionMember1 : ModelBase
{
    /// <summary>
    /// The type of payload in the data field
    /// </summary>
