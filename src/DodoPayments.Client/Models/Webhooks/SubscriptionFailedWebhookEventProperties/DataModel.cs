...
using DodoPayments.Client.Models.Webhooks.SubscriptionFailedWebhookEventProperties.DataProperties.IntersectionMember1Properties;
using System = System;

namespace DodoPayments.Client.Models.Webhooks.SubscriptionFailedWebhookEventProperties;
