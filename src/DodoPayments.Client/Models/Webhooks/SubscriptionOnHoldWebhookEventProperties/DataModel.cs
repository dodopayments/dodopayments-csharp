...
using DodoPayments.Client.Models.Webhooks.SubscriptionOnHoldWebhookEventProperties.DataProperties.IntersectionMember1Properties;
using System = System;

namespace DodoPayments.Client.Models.Webhooks.SubscriptionOnHoldWebhookEventProperties;
