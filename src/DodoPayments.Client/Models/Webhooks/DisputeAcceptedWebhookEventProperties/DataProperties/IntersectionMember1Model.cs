...
using DodoPayments.Client.Models.Webhooks.DisputeAcceptedWebhookEventProperties.DataProperties.IntersectionMember1Properties;

namespace DodoPayments.Client.Models.Webhooks.DisputeAcceptedWebhookEventProperties.DataProperties;
