...
public sealed record class DisputeWonWebhookEvent : JsonModel
{
    ...
    {
        get { return JsonModel.GetNotNullClass<Data5>(this.RawData, "data"); }
    ...
    {
        get { return JsonModel.GetNotNullClass<ApiEnum<string, Type5>>(this.RawData, "type"); }
...
/// Event-specific data
/// </summary>
[JsonConverter(typeof(JsonModelConverter<Data5, Data5FromRaw>))]
public sealed record class Data5 : JsonModel
{
    /// <summary>
    ...
    public ApiEnum<string, Data5IntersectionMember1PayloadType>? PayloadType
    {
        get
        {
            return JsonModel.GetNullableClass<ApiEnum<string, Data5IntersectionMember1PayloadType>>(
                this.RawData,
                "payload_type"
            );
        }
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="Data5FromRaw.FromRawUnchecked"/>
...
class Data5FromRaw : IFromRawJson<Data5>
{
    /// <inheritdoc/>
...
[JsonConverter(
    typeof(JsonModelConverter<Data5IntersectionMember1, Data5IntersectionMember1FromRaw>)
)]
public sealed record class Data5IntersectionMember1 : JsonModel
{
    /// <summary>
    /// The type of payload in the data field
    /// </summary>
    ...
    public Data5IntersectionMember1(Data5IntersectionMember1 data5IntersectionMember1)
        : base(data5IntersectionMember1) { }
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="Data5IntersectionMember1FromRaw.FromRawUnchecked"/>
...
class Data5IntersectionMember1FromRaw : IFromRawJson<Data5IntersectionMember1>
{
    /// <inheritdoc/>
