...
public sealed record class DisputeWonWebhookEvent : ModelBase
{
    ...
    {
        get { return ModelBase.GetNotNullClass<Data5>(this.RawData, "data"); }
    ...
    {
        get { return ModelBase.GetNotNullClass<ApiEnum<string, Type5>>(this.RawData, "type"); }
...
public sealed record class Data5 : ModelBase
{
    ...
    public ApiEnum<string, Data5IntersectionMember1PayloadType>? PayloadType
    {
        get
        {
            return ModelBase.GetNullableClass<ApiEnum<string, Data5IntersectionMember1PayloadType>>(
                this.RawData,
                "payload_type"
            );
        }
