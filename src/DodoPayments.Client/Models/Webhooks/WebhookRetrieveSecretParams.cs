...
/// </summary>
public record class WebhookRetrieveSecretParams : ParamsBase
{
...
#pragma warning disable CS8618
    ...
    {
        this.WebhookID = webhookRetrieveSecretParams.WebhookID;
    }
...
#pragma warning restore CS8618
    ...
    public static WebhookRetrieveSecretParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(WebhookRetrieveSecretParams? other)
    {
        if (other == null)
        {
            return false;
