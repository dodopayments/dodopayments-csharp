        ...
        IFromRaw<DisputeCancelledWebhookEvent>
{
    ...
    /// Event-specific data
    /// </summary>
    public required DisputeCancelledWebhookEventProperties::Data Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<DisputeCancelledWebhookEventProperties::Data>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new DodoPaymentsInvalidDataException(
    ...
    /// The event type
    /// </summary>
    public required ApiEnum<string, DisputeCancelledWebhookEventProperties::Type> Type
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<
                ApiEnum<string, DisputeCancelledWebhookEventProperties::Type>
