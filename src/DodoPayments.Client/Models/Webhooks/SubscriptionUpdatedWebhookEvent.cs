...
public sealed record class SubscriptionUpdatedWebhookEvent : JsonModel
{
    ...
    public required SubscriptionUpdatedWebhookEventData Data
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<SubscriptionUpdatedWebhookEventData>("data");
        }
    ...
    public override void Validate()
    {
        ...
        if (
            !JsonElement.DeepEquals(
                this.Type,
                JsonSerializer.SerializeToElement("subscription.updated")
            )
        )
        {
    ...
    {
        this.Type = JsonSerializer.SerializeToElement("subscription.updated");
    }
...
public sealed record class SubscriptionUpdatedWebhookEventData : JsonModel
{
    ...
    public static implicit operator Subscription(
        ...
        new()
        {
            ...
            BrandID = subscriptionUpdatedWebhookEventData.BrandID,
            ...
            CreditEntitlementCart = subscriptionUpdatedWebhookEventData.CreditEntitlementCart,
            Currency = subscriptionUpdatedWebhookEventData.Currency,
            Customer = subscriptionUpdatedWebhookEventData.Customer,
            HasPaymentMethod = subscriptionUpdatedWebhookEventData.HasPaymentMethod,
            Metadata = subscriptionUpdatedWebhookEventData.Metadata,
            MeterCreditEntitlementCart =
                subscriptionUpdatedWebhookEventData.MeterCreditEntitlementCart,
            ...
            CancellationComment = subscriptionUpdatedWebhookEventData.CancellationComment,
            CancellationFeedback = subscriptionUpdatedWebhookEventData.CancellationFeedback,
            CancelledAt = subscriptionUpdatedWebhookEventData.CancelledAt,
            CustomFieldResponses = subscriptionUpdatedWebhookEventData.CustomFieldResponses,
            CustomerBusinessName = subscriptionUpdatedWebhookEventData.CustomerBusinessName,
            ...
            Discounts = subscriptionUpdatedWebhookEventData.Discounts,
            ExpiresAt = subscriptionUpdatedWebhookEventData.ExpiresAt,
            PausedAt = subscriptionUpdatedWebhookEventData.PausedAt,
            PaymentMethodID = subscriptionUpdatedWebhookEventData.PaymentMethodID,
            ScheduledChange = subscriptionUpdatedWebhookEventData.ScheduledChange,
            TaxID = subscriptionUpdatedWebhookEventData.TaxID,
            TrialAmount = subscriptionUpdatedWebhookEventData.TrialAmount,
        };
