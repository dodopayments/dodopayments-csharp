...
/// </summary>
public record class MeterArchiveParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public static MeterArchiveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(MeterArchiveParams? other)
    {
        if (other == null)
        {
            return false;
