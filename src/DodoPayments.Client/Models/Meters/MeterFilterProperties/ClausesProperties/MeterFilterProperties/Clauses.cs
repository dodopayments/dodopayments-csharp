...
/// </summary>
[JsonConverter(
    typeof(global::DodoPayments.Client.Models.Meters.MeterFilterProperties.ClausesProperties.MeterFilterProperties.ClausesConverter)
)]
public record class Clauses
{
    ...
    public static global::DodoPayments.Client.Models.Meters.MeterFilterProperties.ClausesProperties.MeterFilterProperties.Clauses CreateUnknownVariant(
        JsonElement value
    )
    {
...
sealed class ClausesConverter
    : JsonConverter<global::DodoPayments.Client.Models.Meters.MeterFilterProperties.ClausesProperties.MeterFilterProperties.Clauses>
{
    public override global::DodoPayments.Client.Models.Meters.MeterFilterProperties.ClausesProperties.MeterFilterProperties.Clauses? Read(
    ...
    )
    {
        ...
        try
        {
            ...
            {
                return new global::DodoPayments.Client.Models.Meters.MeterFilterProperties.ClausesProperties.MeterFilterProperties.Clauses(
                    deserialized
                );
            }
        }
    ...
    public override void Write(
        ...
        global::DodoPayments.Client.Models.Meters.MeterFilterProperties.ClausesProperties.MeterFilterProperties.Clauses value,
        JsonSerializerOptions options
    )
    {
