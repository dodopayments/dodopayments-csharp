...
/// </summary>
public record class LicenseValidateParams : ParamsBase
{
    ...
    public string? LicenseKeyInstanceID
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<string>("license_key_instance_id");
        }
...
#pragma warning disable CS8618
    ...
    {
        this._rawBodyData = new(licenseValidateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public virtual bool Equals(LicenseValidateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/licenses/validate")
        {
