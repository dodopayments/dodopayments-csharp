...
public sealed class SubscriptionService : ISubscriptionService
{
    ...
    /// <inheritdoc/>
    public async Task<SubscriptionChangePlanResponse> ChangePlan(
    ...
    /// <inheritdoc/>
    public Task<SubscriptionChangePlanResponse> ChangePlan(
        string subscriptionID,
        SubscriptionChangePlanParams parameters,
        CancellationToken cancellationToken = default
    )
    ...
    /// <inheritdoc/>
    public async Task<SubscriptionRetrieveCreditUsageResponse> RetrieveCreditUsage(
        SubscriptionRetrieveCreditUsageParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        using var response = await this
            .WithRawResponse.RetrieveCreditUsage(parameters, cancellationToken)
            .ConfigureAwait(false);
        return await response.Deserialize(cancellationToken).ConfigureAwait(false);
    }

    /// <inheritdoc/>
    public Task<SubscriptionRetrieveCreditUsageResponse> RetrieveCreditUsage(
        string subscriptionID,
    ...
    )
    {
        ...
        return this.RetrieveCreditUsage(
            parameters with
            {
                SubscriptionID = subscriptionID,
            },
...
public sealed class SubscriptionServiceWithRawResponse : ISubscriptionServiceWithRawResponse
{
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<SubscriptionChangePlanResponse>> ChangePlan(
        SubscriptionChangePlanParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            async (token) =>
            {
                var deserializedResponse = await response
                    .Deserialize<SubscriptionChangePlanResponse>(token)
                    .ConfigureAwait(false);
                if (this._client.ResponseValidation)
                {
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<SubscriptionChangePlanResponse>> ChangePlan(
        string subscriptionID,
        SubscriptionChangePlanParams parameters,
        CancellationToken cancellationToken = default
    )
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<SubscriptionRetrieveCreditUsageResponse>> RetrieveCreditUsage(
        SubscriptionRetrieveCreditUsageParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        HttpRequest<SubscriptionRetrieveCreditUsageParams> request = new()
        {
            Method = HttpMethod.Get,
            Params = parameters,
        };
        ...
        return new(
            ...
            {
                var deserializedResponse = await response
                    .Deserialize<SubscriptionRetrieveCreditUsageResponse>(token)
                    .ConfigureAwait(false);
                if (this._client.ResponseValidation)
                {
                    deserializedResponse.Validate();
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<SubscriptionRetrieveCreditUsageResponse>> RetrieveCreditUsage(
        string subscriptionID,
        SubscriptionRetrieveCreditUsageParams? parameters = null,
        CancellationToken cancellationToken = default
    )
