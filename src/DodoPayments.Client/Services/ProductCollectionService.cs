...
public sealed class ProductCollectionService : IProductCollectionService
{
    ...
    /// <inheritdoc/>
    public async Task<ProductCollectionCreateResponse> Create(
    ...
    /// <inheritdoc/>
    public async Task<ProductCollectionRetrieveResponse> Retrieve(
    ...
    /// <inheritdoc/>
    public Task<ProductCollectionRetrieveResponse> Retrieve(
        string id,
    ...
    : IProductCollectionServiceWithRawResponse
{
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<ProductCollectionCreateResponse>> Create(
        ProductCollectionCreateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            async (token) =>
            {
                var productCollection = await response
                    .Deserialize<ProductCollectionCreateResponse>(token)
                    .ConfigureAwait(false);
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<ProductCollectionRetrieveResponse>> Retrieve(
        ProductCollectionRetrieveParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            {
                var productCollection = await response
                    .Deserialize<ProductCollectionRetrieveResponse>(token)
                    .ConfigureAwait(false);
                if (this._client.ResponseValidation)
                {
                    productCollection.Validate();
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<ProductCollectionRetrieveResponse>> Retrieve(
        string id,
        ProductCollectionRetrieveParams? parameters = null,
        CancellationToken cancellationToken = default
    )
