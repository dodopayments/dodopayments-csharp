...
public sealed class GroupService : IGroupService
{
    ...
    /// <inheritdoc/>
    public async Task<GroupCreateResponse> Create(
    ...
    /// <inheritdoc/>
    public Task<GroupCreateResponse> Create(
        string id,
        GroupCreateParams parameters,
        CancellationToken cancellationToken = default
    )
...
public sealed class GroupServiceWithRawResponse : IGroupServiceWithRawResponse
{
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<GroupCreateResponse>> Create(
        GroupCreateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            async (token) =>
            {
                var group = await response
                    .Deserialize<GroupCreateResponse>(token)
                    .ConfigureAwait(false);
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<GroupCreateResponse>> Create(
        string id,
        GroupCreateParams parameters,
        CancellationToken cancellationToken = default
    )
