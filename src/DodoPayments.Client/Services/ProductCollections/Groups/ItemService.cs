...
public sealed class ItemService : IItemService
{
    ...
    /// <inheritdoc/>
    public async Task<List<ProductCollectionProduct>> Create(
    ...
    /// <inheritdoc/>
    public Task<List<ProductCollectionProduct>> Create(
        string groupID,
        ItemCreateParams parameters,
        CancellationToken cancellationToken = default
    )
...
public sealed class ItemServiceWithRawResponse : IItemServiceWithRawResponse
{
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<List<ProductCollectionProduct>>> Create(
        ItemCreateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            async (token) =>
            {
                var productCollectionProducts = await response
                    .Deserialize<List<ProductCollectionProduct>>(token)
                    .ConfigureAwait(false);
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<List<ProductCollectionProduct>>> Create(
        string groupID,
        ItemCreateParams parameters,
        CancellationToken cancellationToken = default
    )
