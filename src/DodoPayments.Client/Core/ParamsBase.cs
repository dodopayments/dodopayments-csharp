...
public abstract record class ParamsBase
{
    ...
    static ParamsBase()
    {
        ...
        var customHeadersEnv = Environment.GetEnvironmentVariable("DODO_PAYMENTS_CUSTOM_HEADERS");
    ...
    static string GetUserAgent() => $"{typeof(DodoPaymentsClient).Name}/C# {GetPackageVersion()}";
