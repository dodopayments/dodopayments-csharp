...
public abstract record class Price
{
    ...
    public static implicit operator Price(PriceProperties::UsageBasedPrice value) =>
...
sealed class PriceConverter : JsonConverter<Price>
{
    ...
    )
    {
        ...
        try
        {
            var deserialized = JsonSerializer.Deserialize<PriceProperties::UsageBasedPrice>(
                ref reader,
                options
            );
            if (deserialized != null)
    ...
    public override void Write(Utf8JsonWriter writer, Price value, JsonSerializerOptions options)
    {
        object variant = value switch
        {
            ...
            PriceVariants::UsageBasedPrice(var usageBasedPrice) => usageBasedPrice,
