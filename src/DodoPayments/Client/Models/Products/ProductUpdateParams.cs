...
using ProductUpdateParamsProperties = DodoPayments.Client.Models.Products.ProductUpdateParamsProperties;
using System = System;

namespace DodoPayments.Client.Models.Products;

public sealed record class ProductUpdateParams : Client::ParamsBase
{
