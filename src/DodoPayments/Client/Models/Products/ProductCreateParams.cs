...
using ProductCreateParamsProperties = DodoPayments.Client.Models.Products.ProductCreateParamsProperties;
using System = System;

namespace DodoPayments.Client.Models.Products;

public sealed record class ProductCreateParams : Client::ParamsBase
{
