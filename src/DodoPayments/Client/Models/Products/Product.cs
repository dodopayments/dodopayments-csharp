...
using ProductProperties = DodoPayments.Client.Models.Products.ProductProperties;
using System = System;

namespace DodoPayments.Client.Models.Products;

[JsonConverter(typeof(Client::ModelConverter<Product>))]
public sealed record class Product : Client::ModelBase, Client::IFromRaw<Product>
{
    ...
    public required Price Price
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Price>(element, Client::ModelBase.SerializerOptions)
