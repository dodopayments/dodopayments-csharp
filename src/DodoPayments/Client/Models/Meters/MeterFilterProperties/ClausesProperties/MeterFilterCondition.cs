...
using MeterFilterConditionProperties = DodoPayments.Client.Models.Meters.MeterFilterProperties.ClausesProperties.MeterFilterConditionProperties;
using System = System;
...
/// </summary>
[JsonConverter(typeof(Client::ModelConverter<MeterFilterCondition>))]
public sealed record class MeterFilterCondition
    : Client::ModelBase,
        Client::IFromRaw<MeterFilterCondition>
{
    /// <summary>
    /// Filter key to apply
    /// </summary>
