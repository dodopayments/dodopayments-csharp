...
using CheckoutSessionCreateParamsProperties = DodoPayments.Client.Models.CheckoutSessions.CheckoutSessionCreateParamsProperties;
using Client = DodoPayments.Client;
using Payments = DodoPayments.Client.Models.Payments;

namespace DodoPayments.Client.Models.CheckoutSessions;

public sealed record class CheckoutSessionCreateParams : Client::ParamsBase
{
