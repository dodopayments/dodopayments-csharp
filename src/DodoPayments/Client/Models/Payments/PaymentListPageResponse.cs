...
using PaymentListPageResponseProperties = DodoPayments.Client.Models.Payments.PaymentListPageResponseProperties;

namespace DodoPayments.Client.Models.Payments;

[JsonConverter(typeof(Client::ModelConverter<PaymentListPageResponse>))]
public sealed record class PaymentListPageResponse
    : Client::ModelBase,
        Client::IFromRaw<PaymentListPageResponse>
{
