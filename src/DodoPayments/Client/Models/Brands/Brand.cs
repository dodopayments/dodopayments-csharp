...
using BrandProperties = DodoPayments.Client.Models.Brands.BrandProperties;
using Client = DodoPayments.Client;

namespace DodoPayments.Client.Models.Brands;

[JsonConverter(typeof(Client::ModelConverter<Brand>))]
public sealed record class Brand : Client::ModelBase, Client::IFromRaw<Brand>
{
