...
using CustomerWalletTransactionProperties = DodoPayments.Client.Models.Customers.Wallets.LedgerEntries.CustomerWalletTransactionProperties;
using Misc = DodoPayments.Client.Models.Misc;

namespace DodoPayments.Client.Models.Customers.Wallets.LedgerEntries;

[JsonConverter(typeof(Client::ModelConverter<CustomerWalletTransaction>))]
public sealed record class CustomerWalletTransaction
    : Client::ModelBase,
        Client::IFromRaw<CustomerWalletTransaction>
{
