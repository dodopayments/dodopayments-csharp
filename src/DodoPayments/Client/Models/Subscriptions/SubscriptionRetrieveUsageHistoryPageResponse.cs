...
using SubscriptionRetrieveUsageHistoryPageResponseProperties = DodoPayments.Client.Models.Subscriptions.SubscriptionRetrieveUsageHistoryPageResponseProperties;

namespace DodoPayments.Client.Models.Subscriptions;

[JsonConverter(typeof(Client::ModelConverter<SubscriptionRetrieveUsageHistoryPageResponse>))]
public sealed record class SubscriptionRetrieveUsageHistoryPageResponse
    : Client::ModelBase,
        Client::IFromRaw<SubscriptionRetrieveUsageHistoryPageResponse>
{
    /// <summary>
