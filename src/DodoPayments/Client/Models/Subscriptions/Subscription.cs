...
using SubscriptionProperties = DodoPayments.Client.Models.Subscriptions.SubscriptionProperties;
...
/// </summary>
[JsonConverter(typeof(Client::ModelConverter<Subscription>))]
public sealed record class Subscription : Client::ModelBase, Client::IFromRaw<Subscription>
{
    /// <summary>
    ...
    /// </summary>
    public required List<SubscriptionProperties::Meter> Meters
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<SubscriptionProperties::Meter>>(
                    element,
                    Client::ModelBase.SerializerOptions
