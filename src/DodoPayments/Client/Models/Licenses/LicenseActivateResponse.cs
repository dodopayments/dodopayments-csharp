...
using LicenseActivateResponseProperties = DodoPayments.Client.Models.Licenses.LicenseActivateResponseProperties;

namespace DodoPayments.Client.Models.Licenses;

[JsonConverter(typeof(Client::ModelConverter<LicenseActivateResponse>))]
public sealed record class LicenseActivateResponse
    : Client::ModelBase,
        Client::IFromRaw<LicenseActivateResponse>
{
    /// <summary>
