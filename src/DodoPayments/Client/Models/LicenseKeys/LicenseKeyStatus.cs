...
[JsonConverter(typeof(Client::EnumConverter<LicenseKeyStatus, string>))]
public sealed record class LicenseKeyStatus(string value) : Client::IEnum<LicenseKeyStatus, string>
{
