...
using MetadataProperties = DodoPayments.Client.Models.UsageEvents.EventInputProperties.MetadataProperties;
using System = System;

namespace DodoPayments.Client.Models.UsageEvents;

[JsonConverter(typeof(Client::ModelConverter<EventInput>))]
public sealed record class EventInput : Client::ModelBase, Client::IFromRaw<EventInput>
{
    /// <summary>
