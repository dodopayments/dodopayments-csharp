...
using MetadataProperties = DodoPayments.Client.Models.UsageEvents.EventProperties.MetadataProperties;
using System = System;

namespace DodoPayments.Client.Models.UsageEvents;

[JsonConverter(typeof(Client::ModelConverter<Event>))]
public sealed record class Event : Client::ModelBase, Client::IFromRaw<Event>
{
