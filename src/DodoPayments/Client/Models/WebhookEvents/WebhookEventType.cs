...
/// </summary>
[JsonConverter(typeof(Client::EnumConverter<WebhookEventType, string>))]
public sealed record class WebhookEventType(string value) : Client::IEnum<WebhookEventType, string>
{
