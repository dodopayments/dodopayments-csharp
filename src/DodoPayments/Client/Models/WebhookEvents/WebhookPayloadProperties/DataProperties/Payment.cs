...
using IntersectionMember1Properties = DodoPayments.Client.Models.WebhookEvents.WebhookPayloadProperties.DataProperties.PaymentProperties.IntersectionMember1Properties;
...
[JsonConverter(typeof(Client::ModelConverter<Payment>))]
public sealed record class Payment : Client::ModelBase, Client::IFromRaw<Payment>
{
