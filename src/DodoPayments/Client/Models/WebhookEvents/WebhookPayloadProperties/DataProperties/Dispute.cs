...
using IntersectionMember1Properties = DodoPayments.Client.Models.WebhookEvents.WebhookPayloadProperties.DataProperties.DisputeProperties.IntersectionMember1Properties;
using Payments = DodoPayments.Client.Models.Payments;

namespace DodoPayments.Client.Models.WebhookEvents.WebhookPayloadProperties.DataProperties;

[JsonConverter(typeof(Client::ModelConverter<Dispute>))]
public sealed record class Dispute : Client::ModelBase, Client::IFromRaw<Dispute>
{
    /// <summary>
