...
/// </summary>
[JsonConverter(typeof(Client::EnumConverter<DisputeStatus1, string>))]
public sealed record class DisputeStatus1(string value) : Client::IEnum<DisputeStatus1, string>
{
