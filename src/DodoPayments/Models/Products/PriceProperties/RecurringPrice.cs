...
using RecurringPriceProperties = DodoPayments.Models.Products.PriceProperties.RecurringPriceProperties;
using System = System;
...
/// </summary>
[JsonConverter(typeof(DodoPayments::ModelConverter<RecurringPrice>))]
public sealed record class RecurringPrice
    : DodoPayments::ModelBase,
        DodoPayments::IFromRaw<RecurringPrice>
{
    /// <summary>
