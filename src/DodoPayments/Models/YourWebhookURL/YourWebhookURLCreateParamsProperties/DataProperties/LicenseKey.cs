...
using IntersectionMember1Properties = DodoPayments.Models.YourWebhookURL.YourWebhookURLCreateParamsProperties.DataProperties.LicenseKeyProperties.IntersectionMember1Properties;
using LicenseKeys = DodoPayments.Models.LicenseKeys;
