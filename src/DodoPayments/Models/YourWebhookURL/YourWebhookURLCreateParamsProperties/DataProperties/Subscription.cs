...
using IntersectionMember1Properties = DodoPayments.Models.YourWebhookURL.YourWebhookURLCreateParamsProperties.DataProperties.SubscriptionProperties.IntersectionMember1Properties;
using Misc = DodoPayments.Models.Misc;
using Payments = DodoPayments.Models.Payments;
using Subscriptions = DodoPayments.Models.Subscriptions;
...
/// </summary>
[JsonConverter(typeof(DodoPayments::ModelConverter<Subscription>))]
public sealed record class Subscription
    : DodoPayments::ModelBase,
        DodoPayments::IFromRaw<Subscription>
{
    /// <summary>
    ...
    public Subscriptions::Subscription toSubscription()
    {
        return new()
        {
            Addons = Addons,
