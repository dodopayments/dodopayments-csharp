...
using IntersectionMember1Properties = DodoPayments.Models.WebhookEvents.WebhookPayloadProperties.DataProperties.PaymentProperties.IntersectionMember1Properties;
using Misc = DodoPayments.Models.Misc;
using PaymentProperties = DodoPayments.Models.Payments.PaymentProperties;
...
[JsonConverter(typeof(DodoPayments::ModelConverter<Payment>))]
public sealed record class Payment : DodoPayments::ModelBase, DodoPayments::IFromRaw<Payment>
{
    ...
    public required List<Disputes::Dispute> Disputes
    {
        get
        {
            if (!this.Properties.TryGetValue("disputes", out JsonElement element))
                throw new ArgumentOutOfRangeException("disputes", "Missing required argument");

            return JsonSerializer.Deserialize<List<Disputes::Dispute>>(
                    element,
                    DodoPayments::ModelBase.SerializerOptions
                ) ?? throw new ArgumentNullException("disputes");
        }
        set { this.Properties["disputes"] = JsonSerializer.SerializeToElement(value); }
    }
    ...
    /// </summary>
    public required List<Refunds::Refund> Refunds
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<Refunds::Refund>>(
                    element,
                    DodoPayments::ModelBase.SerializerOptions
                ) ?? throw new ArgumentNullException("refunds");
        }
    ...
    public required int SettlementAmount
    {
        ...
        set { this.Properties["settlement_amount"] = JsonSerializer.SerializeToElement(value); }
    }

    public required Misc::Currency SettlementCurrency
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Misc::Currency>(
                    element,
                    DodoPayments::ModelBase.SerializerOptions
                ) ?? throw new ArgumentNullException("settlement_currency");
        }
        set { this.Properties["settlement_currency"] = JsonSerializer.SerializeToElement(value); }
    }
    ...
    /// </summary>
    public Misc::CountryCode? CardIssuingCountry
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Misc::CountryCode?>(
                element,
                DodoPayments::ModelBase.SerializerOptions
            );
        }
        set { this.Properties["card_issuing_country"] = JsonSerializer.SerializeToElement(value); }
    }
    ...
    public string? CardLastFour
    {
        ...
        set { this.Properties["card_last_four"] = JsonSerializer.SerializeToElement(value); }
    }
    ...
    public string? CardNetwork
    {
        ...
        set { this.Properties["card_network"] = JsonSerializer.SerializeToElement(value); }
    }
    ...
    public string? CardType
    {
        ...
        set { this.Properties["card_type"] = JsonSerializer.SerializeToElement(value); }
    }
    ...
    public string? ErrorMessage
    {
        ...
        set { this.Properties["error_message"] = JsonSerializer.SerializeToElement(value); }
    }
    ...
    public int? SettlementTax
    {
        ...
        set { this.Properties["settlement_tax"] = JsonSerializer.SerializeToElement(value); }
    }
    ...
    public Payments::Payment toPayment()
    {
        return new()
        {
            Billing = Billing,
