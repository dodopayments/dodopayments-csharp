...
[JsonConverter(typeof(DodoPayments::ModelConverter<LicenseKeyInstance>))]
public sealed record class LicenseKeyInstance
    : DodoPayments::ModelBase,
        DodoPayments::IFromRaw<LicenseKeyInstance>
{
