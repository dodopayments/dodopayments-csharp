...
/// </summary>
[JsonConverter(typeof(DodoPayments::ModelConverter<AddonCartResponseItem>))]
public sealed record class AddonCartResponseItem
    : DodoPayments::ModelBase,
        DodoPayments::IFromRaw<AddonCartResponseItem>
{
