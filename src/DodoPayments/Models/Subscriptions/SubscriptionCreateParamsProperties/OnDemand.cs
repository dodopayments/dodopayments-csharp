...
namespace DodoPayments.Models.Subscriptions.SubscriptionCreateParamsProperties;

[JsonConverter(typeof(DodoPayments::ModelConverter<OnDemand>))]
public sealed record class OnDemand : DodoPayments::ModelBase, DodoPayments::IFromRaw<OnDemand>
{
    /// <summary>
    ...
    public required bool MandateOnly
    {
        ...
        set { this.Properties["mandate_only"] = JsonSerializer.SerializeToElement(value); }
    }
    ...
    public Currency? ProductCurrency
    {
        ...
        set { this.Properties["product_currency"] = JsonSerializer.SerializeToElement(value); }
    }
    ...
    public string? ProductDescription
    {
        ...
        set { this.Properties["product_description"] = JsonSerializer.SerializeToElement(value); }
    }
    ...
    public int? ProductPrice
    {
        ...
        set { this.Properties["product_price"] = JsonSerializer.SerializeToElement(value); }
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    OnDemand(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static OnDemand FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
        return new(properties);
    }

    [SetsRequiredMembers]
    public OnDemand(bool mandateOnly)
        : this()
    {
