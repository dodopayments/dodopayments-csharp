...
[JsonConverter(typeof(DodoPayments::EnumConverter<RefundStatus, string>))]
public sealed record class RefundStatus(string value) : DodoPayments::IEnum<RefundStatus, string>
{
