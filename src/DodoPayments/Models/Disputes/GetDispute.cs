...
[JsonConverter(typeof(DodoPayments::ModelConverter<GetDispute>))]
public sealed record class GetDispute : DodoPayments::ModelBase, DodoPayments::IFromRaw<GetDispute>
{
    /// <summary>
