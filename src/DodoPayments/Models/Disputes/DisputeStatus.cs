...
[JsonConverter(typeof(DodoPayments::EnumConverter<DisputeStatus, string>))]
public sealed record class DisputeStatus(string value) : DodoPayments::IEnum<DisputeStatus, string>
{
