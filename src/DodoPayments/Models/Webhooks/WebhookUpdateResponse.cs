...
[JsonConverter(typeof(DodoPayments::ModelConverter<WebhookUpdateResponse>))]
public sealed record class WebhookUpdateResponse
    : DodoPayments::ModelBase,
        DodoPayments::IFromRaw<WebhookUpdateResponse>
{
    /// <summary>
    /// The webhook's ID.
    /// </summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    WebhookUpdateResponse(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static WebhookUpdateResponse FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
