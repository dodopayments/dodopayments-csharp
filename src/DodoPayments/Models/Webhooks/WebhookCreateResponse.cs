...
[JsonConverter(typeof(DodoPayments::ModelConverter<WebhookCreateResponse>))]
public sealed record class WebhookCreateResponse
    : DodoPayments::ModelBase,
        DodoPayments::IFromRaw<WebhookCreateResponse>
{
    /// <summary>
    /// The webhook's ID.
    /// </summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    WebhookCreateResponse(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static WebhookCreateResponse FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
