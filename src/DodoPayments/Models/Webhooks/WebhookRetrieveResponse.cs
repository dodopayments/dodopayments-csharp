...
[JsonConverter(typeof(DodoPayments::ModelConverter<WebhookRetrieveResponse>))]
public sealed record class WebhookRetrieveResponse
    : DodoPayments::ModelBase,
        DodoPayments::IFromRaw<WebhookRetrieveResponse>
{
    /// <summary>
    /// The webhook's ID.
    /// </summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    WebhookRetrieveResponse(Dictionary<string, JsonElement> properties)
    {
