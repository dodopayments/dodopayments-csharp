...
namespace DodoPayments.Models.Webhooks.WebhookListPageResponseProperties;

[JsonConverter(typeof(DodoPayments::ModelConverter<Data>))]
public sealed record class Data : DodoPayments::ModelBase, DodoPayments::IFromRaw<Data>
{
    /// <summary>
    /// The webhook's ID.
    /// </summary>
