...
public sealed class DodoPaymentsClient : IDodoPaymentsClient
{
    ...
    readonly System::Lazy<YourWebhookURL::IYourWebhookURLService> _yourWebhookURL;
    public YourWebhookURL::IYourWebhookURLService YourWebhookURL
    {
    ...
    public DodoPaymentsClient()
    {
        ...
        _yourWebhookURL = new(() => new YourWebhookURL::YourWebhookURLService(this));
    }
}
