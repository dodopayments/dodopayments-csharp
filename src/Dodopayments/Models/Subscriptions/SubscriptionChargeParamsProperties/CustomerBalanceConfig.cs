...
namespace Dodopayments.Models.Subscriptions.SubscriptionChargeParamsProperties;

/// <summary>
/// Specify how customer balance is used for the payment
/// </summary>
[JsonConverter(typeof(Dodopayments::ModelConverter<CustomerBalanceConfig>))]
public sealed record class CustomerBalanceConfig
    : Dodopayments::ModelBase,
        Dodopayments::IFromRaw<CustomerBalanceConfig>
{
    /// <summary>
