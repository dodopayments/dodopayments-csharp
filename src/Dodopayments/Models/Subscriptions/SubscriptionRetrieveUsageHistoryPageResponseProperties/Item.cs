...
using ItemProperties = Dodopayments.Models.Subscriptions.SubscriptionRetrieveUsageHistoryPageResponseProperties.ItemProperties;

namespace Dodopayments.Models.Subscriptions.SubscriptionRetrieveUsageHistoryPageResponseProperties;
