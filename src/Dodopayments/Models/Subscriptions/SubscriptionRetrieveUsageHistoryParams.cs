...
/// </summary>
public sealed record class SubscriptionRetrieveUsageHistoryParams : Dodopayments::ParamsBase
{
    ...
    public DateTime? EndDate
    {
        ...
        set { this.QueryProperties["end_date"] = JsonSerializer.SerializeToElement(value); }
    }
    ...
    public DateTime? StartDate
    {
        ...
        set { this.QueryProperties["start_date"] = JsonSerializer.SerializeToElement(value); }
    }
