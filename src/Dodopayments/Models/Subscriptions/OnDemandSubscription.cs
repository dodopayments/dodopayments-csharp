...
[JsonConverter(typeof(Dodopayments::ModelConverter<OnDemandSubscription>))]
public sealed record class OnDemandSubscription
    : Dodopayments::ModelBase,
        Dodopayments::IFromRaw<OnDemandSubscription>
{
    /// <summary>
