...
using MetadataVariants = Dodopayments.Models.UsageEvents.EventProperties.MetadataProperties.MetadataVariants;
using System = System;

namespace Dodopayments.Models.UsageEvents.EventProperties.MetadataProperties;
