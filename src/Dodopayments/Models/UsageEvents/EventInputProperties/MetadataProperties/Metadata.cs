...
using MetadataVariants = Dodopayments.Models.UsageEvents.EventInputProperties.MetadataProperties.MetadataVariants;
using System = System;

namespace Dodopayments.Models.UsageEvents.EventInputProperties.MetadataProperties;
