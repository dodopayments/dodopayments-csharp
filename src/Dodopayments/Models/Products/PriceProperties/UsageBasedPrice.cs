...
using System = System;
using UsageBasedPriceProperties = Dodopayments.Models.Products.PriceProperties.UsageBasedPriceProperties;

namespace Dodopayments.Models.Products.PriceProperties;

/// <summary>
/// Usage Based price details.
/// </summary>
[JsonConverter(typeof(Dodopayments::ModelConverter<UsageBasedPrice>))]
public sealed record class UsageBasedPrice
    : Dodopayments::ModelBase,
        Dodopayments::IFromRaw<UsageBasedPrice>
{
    /// <summary>
