...
using OneTimePriceProperties = Dodopayments.Models.Products.PriceProperties.OneTimePriceProperties;
using System = System;
...
/// </summary>
[JsonConverter(typeof(Dodopayments::ModelConverter<OneTimePrice>))]
public sealed record class OneTimePrice
    : Dodopayments::ModelBase,
        Dodopayments::IFromRaw<OneTimePrice>
{
    /// <summary>
