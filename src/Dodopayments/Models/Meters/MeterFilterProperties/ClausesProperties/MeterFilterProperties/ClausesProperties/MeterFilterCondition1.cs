...
using MeterFilterConditionProperties = Dodopayments.Models.Meters.MeterFilterProperties.ClausesProperties.MeterFilterProperties.ClausesProperties.MeterFilterConditionProperties;
using System = System;
...
/// </summary>
[JsonConverter(typeof(Dodopayments::ModelConverter<MeterFilterCondition1>))]
public sealed record class MeterFilterCondition1
    : Dodopayments::ModelBase,
        Dodopayments::IFromRaw<MeterFilterCondition1>
{
    /// <summary>
    /// Filter key to apply
    /// </summary>
