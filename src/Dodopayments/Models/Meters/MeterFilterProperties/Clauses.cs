...
using ClausesProperties = Dodopayments.Models.Meters.MeterFilterProperties.ClausesProperties;
using ClausesVariants = Dodopayments.Models.Meters.MeterFilterProperties.ClausesVariants;
using System = System;
