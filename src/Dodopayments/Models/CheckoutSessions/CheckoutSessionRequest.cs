...
using CheckoutSessionRequestProperties = Dodopayments.Models.CheckoutSessions.CheckoutSessionRequestProperties;
using Dodopayments = Dodopayments;
using Payments = Dodopayments.Models.Payments;

namespace Dodopayments.Models.CheckoutSessions;

[JsonConverter(typeof(Dodopayments::ModelConverter<CheckoutSessionRequest>))]
public sealed record class CheckoutSessionRequest
    : Dodopayments::ModelBase,
        Dodopayments::IFromRaw<CheckoutSessionRequest>
{
