...
/// </summary>
[JsonConverter(typeof(Dodopayments::EnumConverter<CountryCode, string>))]
public sealed record class CountryCode(string value) : Dodopayments::IEnum<CountryCode, string>
{
